                ...
                <div id="filter" class="col-xl-3 col-lg-3 col-md-4 col-12 mb-4 mb-lg-0">
                    ...
                    <div class="card">
                        ...
                        <!-- <div class="card-body border-top p-0 mb-2">
                            ...
                            <?php
                                $institutionInfo = $conn->query("SELECT u.university_name, i.institution_id, i.institution_user_id 
                            ...
                            ?>
                                    <div class="d-block">
                                        <div class="form-check mb-1 ms-4 me-2">
                                            ...
                                            <label class="form-check-label" for="inst-<?= $institutionInfoRow->university_id ?>"><?= $institutionInfoRow->university_name ?></label>
                                        </div>
                                    </div>
                            <?php
                                }
