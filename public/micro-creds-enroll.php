                ...
                <div class="col-lg-4 col-md-12 col-12 mt-lg-n22">
                    ...
                    <div class="card mb-3 mb-4">
                        <div class="p-1">
                            <div class="d-flex justify-content-center position-relative rounded py-10 border-white border rounded-3 bg-cover" 
                                style="background-image: url('<?=  "../assets/images/microcredential/" . $data["mc_image"] ?>')">
                    ...
                    ?>
                            ...
                            <div id="addtocart" class="d-flex align-items-center">
                                ...
                                <a class="btn btn-primary me-2 w-100" href="../registerselection.php">
                                Buy Now</a>
                                ...
                                <button type="button" class="btn btn-warning btn-icon <?= $disabledEnroll ?>" data-id="<?= $data["mc_id"] ?>" data-type="mc" data-function="addtocart"
