...
if(isset($_POST["matchedSearch"])) {
    ...
    if(($courseSearch !== NULL) || ($mcSearch !== NULL)) {
        if($courseSearch === NULL) {
            $searchResult = parseMC($mcSearch);
        } else if($mcSearch === NULL) {
            $searchResult = parseCourse($courseSearch);
        } else {
            $searchResult = array_merge(parseCourse($courseSearch), parseMC($mcSearch));
        }
