                                                                ...
                                                                <div class="mb-3">
                                                                    <div class="custom-file-container" data-upload-id="courseCoverImg<?php echo $rows->mc_id; ?>" id="courseCoverImg<?php echo $rows->mc_id; ?>">
                                                                        ...
                                                                        <label class="custom-file-container__custom-file">
                                                                            <input type="file" class="custom-file-container__custom-file__custom-file-input" accept="image/jpeg, image/png" name="mccoverimg" id="pictureUpload">
                                                ...
                                                <div>
                                                    <div>
                                                        <button type="button" class="btn btn-warning waves-effect waves-light btn-sm shadow text-dark" data-bs-toggle="modal" data-bs-target="#editcoursecredittransfer<?php echo $rows->mccct_id; ?>">
                                                            <i class="fe fe-edit fs-5 me-1"></i>Edit</button>
                                                        <a class="btn btn-danger waves-effect waves-light btn-sm shadow text-dark" href="committee-function.php?delete_mccct=<?php echo $rows->mccct_id; ?>&mcid=<?php echo $rows->mc_id; ?>" title="Delete Course Credit Transfer" onclick="return deletemccct()">
