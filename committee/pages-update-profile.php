                    ...
                    <div class="col-lg-10 col-md-8 col-12 mx-auto">
                        ...
                        <div class="card">
                            ...
                            $queryCommittee = $conn->query("SELECT * FROM committee
                             ...
                             LEFT JOIN institution ON committee_institution_id = institution.institution_id 
                                    ...
                                    <div class="card-body">
                                        <div class="d-lg-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center mb-4 mb-lg-0">
                                                ...
                                                if ($rows->committee_logo != NULL) {
                                                    // $ProfilePic = '../assets/images/avatar/' . $rows->committee_logo;
                                                } else {
                                                    $ProfilePic = '../assets/images/avatar/avatardefault.png';
                                                }
                                                ?>
                                                <img alt="avatar" src="<?php echo $ProfilePic; ?>" id="img-uploaded" class="avatar-xl rounded-circle" alt="" />
                                                <div class="ms-3">
                                                    <h4 class="mb-0"><?php echo $rows->committee_name; ?>'s picture</h4>
                                                    <p class="mb-0">
                                                        ...
                                                        <form action="" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="mb-3 col-md-12 text-center">
                                                                ...
                                                                <div class="input-group mb-1">
                                                                    <input class="dropify form-control" accept="image/jpeg, image/png" type="file" name="committee_logo" onchange="displayImage(this)" id="institution_logo" style="display: none;">
                                                                </div>
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <input type="email" name="committee_email" class="form-control" value="<?php echo $rows->committee_email; ?>" required />

                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                                    <label class="form-label" for="phone">Contact No:</label>
                                                                    <input type="text" name="committee_contact_no" class="form-control" value="<?php echo $rows->committee_contact_no; ?>" required />
                                                                </div>
                                                        ...
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <textarea type="text" name="committee_address" class="form-control" required><?php echo $rows->committee_address; ?></textarea>
                                                        </div>
                                                        </div>
