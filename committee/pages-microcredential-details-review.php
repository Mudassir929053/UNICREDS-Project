                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                            ...
                            <div>                           
                                <a class="btn btn-primary waves-effect btn-sm shadow text-white" href="pages-microcredential-content-review.php?mcid=<?php echo $mcid; ?>">
                                <i class="fe fe-folder fs-5 me-1"></i> View Content </a>
                                        ...
                                        <div class="row align-items-center g-0 mt-1 ">
                                            <div class="col-auto">
                                                ...
                                                if ($rows->institution_logo != NULL) {
                                                    $ProfilePic = '../institution/images/' . $rows->institution_logo;
                                                } else {
