                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mcn_status == 'Published') : ?>
                                                         <a href="committee-function.php?unpublish_mcn=<?php echo $rows->mcn_id; ?>" title="Unpublish Note" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishnote()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mcn_status == 'Save Only') : ?>
                                                         <a href="committee-function.php?publish_mcn=<?php echo $rows->mcn_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Note" onclick="return publishnote()">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" class="form-control custom-file-input" accept="image/jpeg, image/png" name="mcn_attachment" id="mnn_attachment<?php echo $rows->mcn_id; ?>">
                                                   ...
                                                   <a href="committee-function.php?delete_mcn=<?php echo $rows->mcn_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcn()">
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmcnote_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" accept="image/jpeg, image/png" type="file" name="mcn_attachment" id="mcn_attachment">
                                             ...
                                             <div>
                                                ...
                                                <a class="me-1 text-inherit" href="#">
                                                   <?php if ($rows->mcv_status == 'Published') : ?>
                                                      <a href="committee-function.php?unpublish_mcv=<?php echo $rows->mcv_id; ?>" title="Unpublish Video" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishvideo()">
                                                         <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                   <?php if ($rows->mcv_status == 'Save Only') : ?>
                                                      <a href="committee-function.php?publish_mcv=<?php echo $rows->mcv_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Video" onclick="return publishvideo()">
                                                         <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                </a>
                                                         ...
                                                         <div class="modal-body">
                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                               ...
                                                               <div class="mb-3 col-md-12">
                                                                  ...
                                                                  <div class="custom-file">
                                                                     <div class="input-group mb-1">
                                                                        <input type="file" accept="video/mp4, video/webm" onChange="readURL(this);" class="form-control custom-file-input" name="mcv_attachment" id="mcv_attachment<?php echo $rows->mcv_id; ?>">
                                                ...
                                                <a href="committee-function.php?delete_mcv=<?php echo $rows->mcv_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcv()">
                                                   <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmcn_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" accept="video/mp4, video/webm" type="file" name="mcv_attachment" id="mcv_attachment">
                                             ...
                                             <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div>
                                                   <span class="<?php if ($rows->mcs_status == 'Published') {
                                                                     ...
                                                                     echo "badge bg-warning";
                                                                  } ?>"><?php echo $rows->mcs_status; ?></span>

                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mcs_status == 'Published') : ?>
                                                         <a href="committee-function.php?unpublish_mcs=<?php echo $rows->mcs_id; ?>" title="Unpublish Slide" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishslide()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mcs_status == 'Save Only') : ?>
                                                         <a href="committee-function.php?publish_mcs=<?php echo $rows->mcs_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Slide" onclick="return publishslide()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                            ...
                                                            <div class="modal-body">
                                                               <form action="" method="POST" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" accept="video/mp4, video/webm" class="form-control custom-file-input" name="mcs_attachment" id="mcs_attachment<?php echo $rows->mcs_id; ?>">
                                                   ...
                                                   <a href="committee-function.php?delete_mcs=<?php echo $rows->mcs_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcs()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmcslide_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" accept="video/mp4, video/webm" type="file" name="mcs_attachment" id="mcs_attachment">
