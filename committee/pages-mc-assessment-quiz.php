    ...
    <div id="db-wrapper">
        ...
        <div id="page-content">
            ...
            <div class="container-fluid p-4">
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center ">
                                                        <button type="button" class="btn btn-sm btn-warning text-white" data-bs-toggle="modal" data-bs-target="#editquestion<?php echo $rows->mcqq_id; ?>"><i class="fa fa-edit" aria-hidden="true"></i>Edit</button></a>
                                                        <a class="btn btn-sm btn-danger" href="committee-function.php?delete_quiz_question=<?php echo $rows->mcqq_id; ?>&question_answer=<?php echo $rows->mcqa_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                                    </td>
                                                </tr>
                                        <?php
                                            }
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" method="POST" enctype="multipart/form-data" id="addquestion" autocomplete="off">
                                    ...
                                    <input type="hidden" name="mcq_id" value="<?php echo $mcqid; ?>">
                                    <div class="mb-3">
                                        <label class="form-label">Question Type:</label>
                                        <select class="selectpicker " data-width="100%" name="mcq_question_type" id="mcq_question_type" onchange="showDiv(this)" required>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="mcq_question" id="editornewquestion"></textarea>
                ...
                <?php
                $queryquizquestion1 = $conn->query("SELECT * from mc_quiz_question  
                                                    LEFT JOIN mc_quiz_answer ON mcqq_id = mc_quiz_answer.mcqa_mc_quiz_question_id
                                                    WHERE mcqq_mc_quiz_id = $mcqid AND mcqq_deleted_date IS NULL;");
                $num = 1;
                ...
                ?>
                    ...
                    <div class="modal fade" id="editquestion<?php echo $row1->mcqq_id; ?>" tabindex="-1" role="dialog" aria-labelledby="questionmodal" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addquestion" autocomplete="off">
                                        <input type="hidden" name="mc_id" value="<?php echo $mcid; ?>">
                                        <input type="hidden" name="mcq_id" value="<?php echo $mcqid; ?>">
                                        <input type="hidden" name="mcqq_id" value="<?php echo $row1->mcqq_id; ?>">
                                        <input type="hidden" name="mcqa_id" value="<?php echo $row1->mcqa_id; ?>">
                                        <input type="hidden" name="mcqq_type" value="<?php echo $row1->mcqq_type; ?>">
                                        <div class="mb-3">
                                            <label class="form-label">Question Type:</label>
                                            <select class="selectpicker " data-width="100%" disabled>
                                                <option value="<?php echo $row1->mcqq_type; ?>" <?php if($row1 -> mcqq_type == "Multiple Choice"){echo "selected";} else {}?>><?php echo $row1->mcqq_type; ?></option>
                                                <option value="<?php echo $row1->mcqq_type; ?>" <?php if($row1 -> mcqq_type == "True/False"){echo "selected";} else {}?>><?php echo $row1->mcqq_type; ?></option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <label class="form-label">Question :</label>
                                            <textarea class="form-control" name="new_mcq_question" id="editornewquestion<?php echo $row1->mcqq_id; ?>"><?php echo $row1->mcqq_question; ?></textarea>

                                            <script>
                                                ClassicEditor
                                                    .create(document.querySelector('#editornewquestion<?php echo $row1->mcqq_id; ?>'), {
                                        ...
                                        <?php if ($row1->mcqq_type == 'Multiple Choice') { ?>
                                            <div>
                                                <label class="form-label">Answers:</label>
                                                ...
                                                <table class="table table-bordered no-wrap table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <ul>
                                                                    <input type="radio" class="check" value="1" name="new_answermulchoice" <?php if ($row1->mcqa_right_answer == "1") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                                                </ul>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="new_question_answer1" placeholder="Answer" class="form-control form-control-sm" value="<?php echo $row1->mcqa_answer1; ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <ul>
                                                                    <input type="radio" class="check" value="2" name="new_answermulchoice" <?php if ($row1->mcqa_right_answer == "2") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                                                </ul>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="new_question_answer2" placeholder="Answer" class="form-control form-control-sm" value="<?php echo $row1->mcqa_answer2; ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <ul>
                                                                    <input type="radio" class="check" value="3" name="new_answermulchoice" <?php if ($row1->mcqa_right_answer == "3") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                                                </ul>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="new_question_answer3" placeholder="Answer" class="form-control form-control-sm" value="<?php echo $row1->mcqa_answer3; ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <ul>
                                                                    <input type="radio" class="check" value="4" name="new_answermulchoice" <?php if ($row1->mcqa_right_answer == "4") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                                                </ul>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="new_question_answer4" placeholder="Answer" class="form-control form-control-sm" value="<?php echo $row1->mcqa_answer4; ?>">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                        <?php } elseif ($row1->mcqq_type == 'True/False') {  ?>
                                            <div>
                                                <label class="form-label">Answers:</label>
                                                ...
                                                <table class="table table-bordered no-wrap table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <ul>
                                                                    <input type="radio" class="check" value="5" name="new_answertf" <?php if ($row1->mcqa_right_answer == "5") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                                                </ul>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <input type="text" name="new_question_answer5" placeholder="Answer" class="form-control form-control-sm" value="<?php echo $row1->mcqa_answer1; ?>">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>
                                                                <ul>
                                                                    <input type="radio" class="check" value="6" name="new_answertf" <?php if ($row1->mcqa_right_answer == "6") {
                                                                                                                                                echo 'checked';
                                                                                                                                            } ?>>
                                                                </ul>
                                                            </td>
                                                            <td>
                                                                <input type="text" name="new_question_answer6" placeholder="Answer" class="form-control form-control-sm" value="<?php echo $row1->mcqa_answer2; ?>">
                                                            </td>
                                                        </tr>
