                     ...
                     <div class="tab-pane <?php if ($assessment_type == "Quiz") {
                        ...
                        <div class="bg-light-info rounded p-2 mb-3 shadow">
                           ...
                           $querymcq = $conn->query("SELECT * FROM mc_quiz
                                                     LEFT JOIN microcredential ON microcredential.mc_id = mcq_mc_id
                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mcq_status == 'Published') : ?>
                                                         <a href="committee-function.php?unpublish_mcq=<?php echo $rows->mcq_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mcq_status == 'Save Only') : ?>
                                                         <a href="committee-function.php?publish_mcq=<?php echo $rows->mcq_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                                                   ...
                                                   <a href="committee-function.php?delete_mcq=<?php echo $rows->mcq_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcq()">
                     ...
                     <div class="tab-pane <?php if ($assessment_type == "Test") {
                        ...
                        <div class="bg-light-info rounded p-2 mb-3 shadow">
                           ...
                           $querymct = $conn->query("SELECT * FROM mc_test
                                                     LEFT JOIN microcredential ON microcredential.mc_id = mct_mc_id
                                             ...
                                             <div>
                                                ...
                                                <a class="me-1 text-inherit" href="#">
                                                   <?php if ($rows->mct_status == 'Published') : ?>
                                                      <a href="committee-function.php?unpublish_mct=<?php echo $rows->mct_id; ?>" title="Unpublish Test" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishtest()">
                                                         <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                   <?php if ($rows->mct_status == 'Save Only') : ?>
                                                      <a href="committee-function.php?publish_mct=<?php echo $rows->mct_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Test" onclick="return publishtest()">
                                                         <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                </a>
                                                ...
                                                <a href="committee-function.php?delete_mct=<?php echo $rows->mct_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemct()">
                                                   <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                     ...
                     <div class="tab-pane <?php if ($assessment_type == "Tutorial") {
                        ...
                        <div class="bg-light-info rounded p-2 mb-3 shadow">
                           ...
                           $querymctu = $conn->query("SELECT * FROM mc_tutorial
                                                      LEFT JOIN microcredential ON microcredential.mc_id = mctu_mc_id
                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mctu_status == 'Published') : ?>
                                                         <a href="committee-function.php?unpublish_mctu=<?php echo $rows->mctu_id; ?>" title="Unpublish Tutorial" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishtutorial()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mctu_status == 'Save Only') : ?>
                                                         <a href="committee-function.php?publish_mctu=<?php echo $rows->mctu_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Tutorial" onclick="return publishtutorial()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" accept="image/jpeg, image/png" onChange="readURL(this);" class="form-control custom-file-input" name="mctu_attachment" id="mctu_attachment<?php echo $rows->mctu_id; ?>">
                                                   ...
                                                   <a href="committee-function.php?delete_mctu=<?php echo $rows->mctu_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemctu()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmctutorial_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" accept="image/jpeg, image/png" type="file" name="mctu_attachment" id="mctu_attachment">
