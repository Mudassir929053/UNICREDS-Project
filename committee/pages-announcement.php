									...
									<form action="" method="POST" enctype="multipart/form-data" id="announcement">
										...
										<div class="mb-3">
											...
											<div class="input-group mb-1">
												<input class="dropify form-control" accept="image/jpeg, image/png" type="file" name="announcement_attachment" id="announcement_attachment">
									...
									<div class="table-responsive">
										<table id="dataTableBasic1" class="table table-hover display no-wrap table-sm" style="width:100%">
											...
											<tbody class="align-middle">
												<?php
												$queryAnnouncement = $conn->query("SELECT * FROM announcement_committee WHERE announcement_created_by = '$committee_id';");
												$num = 1;
												...
												?>
														<tr>
															...
															<td class="text-center">
																...
																<a class="btn btn-danger btn-sm waves-effect waves-light" href="committee-function.php?delete_announcement=<?php echo $row->announcement_id; ?>" title="Delete Announcement" onClick="return deleteannouncement()">
																		...
																		<form action="" method="POST" enctype="multipart/form-data">
																			...
																			<div class="mb-3">
																				...
																				<div class="custom-file">
																					<div class="input-group mb-1">
																						<input type="file" accept="image/jpeg, image/png" onChange="readURL(this);" class="form-control custom-file-input" name="announcement_attachment" id="announcement_attachment<?php echo $row->announcement_id; ?>">
