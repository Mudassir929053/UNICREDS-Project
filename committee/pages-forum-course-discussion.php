        ...
        <div id="page-content">
            ...
            <div class="container-fluid p-4">
                ...
                ?>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                                        <div class="modal-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <script>
                                                    ClassicEditor
                                                        .create(document.querySelector('#forummessage_<?php echo $fpc_id; ?>'), {
                        ...
                        <a class="btn btn-sm btn-outline-danger waves-effect waves-light" href="committee-function.php?delete_forum_message=<?php echo $fpc_id; ?>&fpc_topic_id=<?php echo $topic_id; ?>&fpc_instructor=<?php echo $get_userID; ?>" title="Delete Topic" onclick="return deleteforummessage()">
