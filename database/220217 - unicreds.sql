...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2022 at 05:28 AM
...
CREATE TABLE `job_student_university_application` (
  ...
  `jsua_status` varchar(10) NOT NULL,
...
ALTER TABLE `announcement_industry`
  ADD PRIMARY KEY (`announcement_id`),
  ADD KEY `FK_ai_industry` (`announcement_created_by`);
...
ALTER TABLE `announcement_institution`
  ADD PRIMARY KEY (`announcement_id`),
  ADD KEY `FK_ain_institution` (`announcement_created_by`);
...
ALTER TABLE `announcement_lecturer`
  ADD PRIMARY KEY (`announcement_id`),
  ADD KEY `FK_al_lecturer` (`announcement_created_by`);
...
ALTER TABLE `commission`
  ...
  ADD KEY `FK_commission_institution` (`user_id`),
...
ALTER TABLE `studuni_mc_test_result`
  ...
  ADD KEY `FK_sumctrs_test` (`sumctrs_mc_test_id`);
...
ALTER TABLE `studuni_mc_tutorial_submission`
  ...
  ADD KEY `FK_sumctus_tutorial` (`sumctus_mc_tutorial_id`);
...
ALTER TABLE `studuni_mc_watched_video`
  ...
  ADD KEY `FK_sumcvw_video` (`sumcvw_mc_video_id`);
...
--
ALTER TABLE `studuni_mc_assignment_submission`
  MODIFY `sumcas_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `studuni_mc_project_submission`
--
ALTER TABLE `studuni_mc_project_submission`
  MODIFY `sumcps_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `announcement_industry`
--
ALTER TABLE `announcement_industry`
  ADD CONSTRAINT `FK_ai_industry` FOREIGN KEY (`announcement_created_by`) REFERENCES `industry` (`industry_id`);

--
-- Constraints for table `announcement_institution`
--
ALTER TABLE `announcement_institution`
  ADD CONSTRAINT `FK_ain_institution` FOREIGN KEY (`announcement_created_by`) REFERENCES `institution` (`institution_id`);

--
-- Constraints for table `announcement_lecturer`
--
ALTER TABLE `announcement_lecturer`
  ADD CONSTRAINT `FK_al_lecturer` FOREIGN KEY (`announcement_created_by`) REFERENCES `lecturer` (`lecturer_id`);
...
--
ALTER TABLE `commission_rate`
  ADD CONSTRAINT `FK_commission_rate_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`);
...
--
ALTER TABLE `studuni_course_quiz_review`
  ADD CONSTRAINT `FK_sucqr_course_quiz` FOREIGN KEY (`sucqrv_course_quiz_id`) REFERENCES `course_quiz` (`cq_id`),
  ADD CONSTRAINT `FK_sucqr_course_quiz_question` FOREIGN KEY (`sucqrv_course_quiz_question_id`) REFERENCES `course_quiz_question` (`cqq_id`),
  ADD CONSTRAINT `FK_sucqr_student_university` FOREIGN KEY (`sucqrv_student_university_id`) REFERENCES `student_university` (`su_id`);

--
-- Constraints for table `studuni_course_test_result`
--
ALTER TABLE `studuni_course_test_result`
  ADD CONSTRAINT `FK_sucts_course_test` FOREIGN KEY (`suctrs_course_test_id`) REFERENCES `course_test` (`ct_id`),
  ADD CONSTRAINT `FK_sucts_student_university` FOREIGN KEY (`suctrs_student_university_id`) REFERENCES `student_university` (`su_id`);

--
-- Constraints for table `studuni_course_test_review`
--
ALTER TABLE `studuni_course_test_review`
  ADD CONSTRAINT `FK_suctr_course_test` FOREIGN KEY (`suctrv_course_test_id`) REFERENCES `course_test` (`ct_id`),
  ADD CONSTRAINT `FK_suctr_course_test_question` FOREIGN KEY (`suctrv_course_test_question_id`) REFERENCES `course_test_question` (`ctq_id`),
  ADD CONSTRAINT `FK_suctr_student_university` FOREIGN KEY (`suctrv_student_university_id`) REFERENCES `student_university` (`su_id`);
...
--
ALTER TABLE `studuni_mc_quiz_result`
  ADD CONSTRAINT `FK_sumcqs_mc_quiz` FOREIGN KEY (`sumcqrs_mc_quiz_id`) REFERENCES `mc_quiz` (`mcq_id`),
  ADD CONSTRAINT `FK_sumcqs_student_university` FOREIGN KEY (`sumcqrs_student_university_id`) REFERENCES `student_university` (`su_id`);

--
-- Constraints for table `studuni_mc_quiz_review`
--
ALTER TABLE `studuni_mc_quiz_review`
  ADD CONSTRAINT `FK_sumcqr_mc_quiz` FOREIGN KEY (`sumcqrv_mc_quiz_id`) REFERENCES `mc_quiz` (`mcq_id`),
  ADD CONSTRAINT `FK_sumcqr_mc_quiz_question` FOREIGN KEY (`sumcqrv_mc_quiz_question_id`) REFERENCES `mc_quiz_question` (`mcqq_id`),
  ADD CONSTRAINT `FK_sumcqr_student_university` FOREIGN KEY (`sumcqrv_student_university_id`) REFERENCES `student_university` (`su_id`);
...
ALTER TABLE `studuni_mc_test_result`
  ...
  ADD CONSTRAINT `FK_sumctrs_test` FOREIGN KEY (`sumctrs_mc_test_id`) REFERENCES `mc_test` (`mct_id`);
...
ALTER TABLE `studuni_mc_tutorial_submission`
  ...
  ADD CONSTRAINT `FK_sumctus_tutorial` FOREIGN KEY (`sumctus_mc_tutorial_id`) REFERENCES `mc_tutorial` (`mctu_id`);
...
ALTER TABLE `studuni_mc_watched_video`
  ...
  ADD CONSTRAINT `FK_sumcvw_video` FOREIGN KEY (`sumcvw_mc_video_id`) REFERENCES `mc_video` (`mcv_id`);
