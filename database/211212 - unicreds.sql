...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2021 at 01:48 AM
...
CREATE TABLE `course` (
  ...
  `course_level` enum('Diploma','Degree','Master','PhD') NOT NULL,
  ...
  `course_type` enum('Academic','Non-academic') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `course_tutorial` (
  ...
  `ctu_updated_date` datetime DEFAULT NULL,
...
(1, 9, 2, '2021-12-08 11:39:37', NULL, 'Not started', '2021-12-08 11:39:37'),
(2, 9, 3, '2021-12-09 08:36:31', NULL, 'Not started', '2021-12-09 08:36:31');
...
(1, 24, 6, 'EDESS Education Development & Solution Specialist Sdn Bhd 1', 'edess@gmail.com', 'https://edess.asia/', '07 550 0077 1', NULL, NULL, NULL, NULL, NULL, '20211108154018Invoice - Bootstrap Themes.pdf', 1, NULL, '2021-09-20 16:03:20', '2021-11-15 05:55:33', NULL, 'Active', 'PASSPORT.JPG'),
(2, 25, 6, 'test', 'tes111@yahoo.com', 'https://www.petronas.com', '017-7168361', NULL, NULL, NULL, NULL, NULL, '', 1, NULL, '2021-09-20 16:05:50', NULL, '2021-09-28 10:50:27', 'Active', NULL),
(3, 33, 6, 'EDESS', 'edess321@gmail.com', 'https://edess.asia/', '0177168361', NULL, NULL, NULL, NULL, NULL, '', 35, NULL, '2021-09-26 09:22:10', '2021-09-28 10:53:30', '2021-10-05 08:41:28', 'Active', NULL),
(4, 36, 6, 'INTEGRASYS SOLUTION SDN BHD', 'integrasys@gmail.com', 'integrasys.my', '0123456788', NULL, NULL, NULL, NULL, NULL, '', 64, NULL, '2021-09-28 09:11:58', '2021-09-28 10:52:05', '2021-10-05 08:41:24', 'Active', NULL);
...
(1, 1, 'Artificial Intelligence', 'AI112', '1, 3', NULL, 27, '2021-12-02 15:31:27', '2021-12-06 09:04:47', NULL),
(2, 2, 'Computational Programming', 'CP123', '1, 3', NULL, 27, '2021-12-07 15:55:12', NULL, NULL),
(3, 3, 'Renewable Energy', 'EPO622', '1', NULL, 27, '2021-12-07 16:46:26', NULL, NULL);
...
(1, 1, '<p>Know <strong>the main types of neural networks</strong>; Know and apply the methods of training neural networks; Know the application of artificial neural networks; To be able to formalize the problem, to solve it by using a neural network.</p>', 'Undergraduate student\r\nPostgraduate student', 'basic neural network knowledge required', 'Will be able to design neural network architecture'),
(2, 2, '<ul><li>Menerangkan konsep asas pemikiran komputasional</li><li>Mengenal pasti komponen dan fungsi robot</li><li>Menyelesaikan masalah berasaskan robot dengan konsep</li><li>membina penyelesaian atur cara C dengan menggunakan kemahiran pemikiran komputasional dalam permainan robot</li></ul>', 'Kursus ini melibatkan video dan nota untuk modul pembelajaran, pembelajaran kendiri dan penilaian rasmi.', 'Adalah lebih baik bagi peserta untuk mempunyai line following robot mudah alih supaya peserta boleh menjalankan semua aktiviti yang diberikan. Selain itu, peserta juga digalakkan untuk menyediakan alat kelengkapan yang dipermulakan untuk aktiviti di akhir', 'Menerangkan konsep asas pemikiran komputasional'),
(3, 3, '<ul><li>Identify the fundamental principles of renewable energy technologies.&nbsp;</li><li>Explain the process and technologies employed in renewable energy-based power generation.</li><li>Design renewable energy power system based on Malaysia and international standard practice.<br>&nbsp;</li></ul>', 'Undergraduate Students', 'No prerequisite knowledge is required', 'Identify the fundamental principles of renewable energy technologies. ');
...
(1, 2, 'Note Topic 1', '<p>topic 1 is introduction</p>', '20211208121627Guideline on Micro-credential 10 Mei.pdf', NULL, '2021-12-08 12:16:27', 27, NULL, NULL, 'Save Only'),
(3, 2, 'Note Topic 2', '<p>Topic 2</p>', '20211208122105JFA41A20215.pdf', NULL, '2021-12-08 12:21:05', 27, NULL, NULL, 'Save Only');
...
(1, 2, 'Quiz 1', '<p>quiz 1&nbsp;</p>', 30, NULL, '2021-12-08 12:22:03', 27, '2021-12-08 16:31:56', NULL, 'Published'),
(3, 1, 'test', '<p>test</p>', 45, NULL, '2021-12-08 16:30:14', 27, '2021-12-08 16:32:04', NULL, 'Published'),
(4, 3, 'Quiz 1', '<p>test</p>', 2600, NULL, '2021-12-09 08:35:38', 27, '2021-12-09 08:37:58', NULL, 'Published'),
(5, 3, 'Quiz 2', '<p>qqweq</p>', 60, NULL, '2021-12-09 09:03:28', 27, NULL, NULL, 'Published');
...
(1, 1, 'A. Johor', 'B. Melaka', 'C. Selangor', 'D. Sabah', '1', 'A. Johor'),
(2, 2, 'A. Donald Trump', 'B. Ismail Sabri', 'C. Najib Razak', 'D. Mahathir Mohamad', '2', 'B. Ismail Sabri'),
(3, 3, 'Aku', 'Dia', 'Kamu ', 'Kita', '1', 'Aku');
...
CREATE TABLE `mc_quiz_question` (
  ...
  `mcqq_type` varchar(10) DEFAULT NULL,
...
(1, 1, 'MCQ', '<p>Dimanakah terletaknya daerah Pontian</p>', NULL, '2021-12-08 12:24:06', '2021-12-08 12:53:18', NULL),
(2, 1, 'MCQ', '<p>Siapakah Perdana Menteri Malaysia sekarang?</p>', NULL, '2021-12-08 12:25:44', '2021-12-08 12:53:27', NULL),
(3, 4, 'MCQ', '<p>Siapakah dia</p>', NULL, '2021-12-09 08:36:10', '2021-12-09 08:39:34', NULL);
...
CREATE TABLE `mc_test` (
  ...
  `mct_duration` time DEFAULT NULL,
...
(1, 1, 'Test 1', '<p>reada</p>', '00:00:15', NULL, '2021-12-06 15:15:23', 27, NULL, NULL, 'Published'),
(2, 2, 'Test Topic 1', '<p>Topic 1 test</p>', '00:00:15', NULL, '2021-12-08 12:26:24', 27, NULL, NULL, 'Published');
...
(1, 1, 'A. Kedah', 'B. Melaka', 'C. Terengganu', 'D. Sarawak', '3', 'C. Terengganu'),
(2, 2, 'A. Zahir Hamidi', 'B. Hizam Baktee', 'C. Ahmad Maslan', 'D. Khairy Jamaluddin', '4', 'D. Khairy Jamaluddin');
...
(1, 2, 'MCQ', '<p>Dimanakah daerah Besut?</p>', 0, '2021-12-08 12:28:07', '2021-12-08 12:42:24', NULL),
(2, 2, 'MCQ', '<p>Siapakah Menteri Kesihatan Malaysia?</p><p>&nbsp;</p>', 0, '2021-12-08 12:30:10', '2021-12-08 12:42:31', NULL);
...
(1, 1, 'Javascript', '<p>test</p>', '20211208090956What is JavaScript_.mp4', '5m 12s ', '2021-12-08 09:09:56', 27, NULL, NULL, 'Save Only'),
(2, 2, 'Introduction', '<p>introduction video</p>', '20211208121551videoplayback.mp4', '1h  9s ', '2021-12-08 12:15:51', 27, NULL, NULL, 'Save Only');
...
(1, 'Neural Network', 'NN112', '<p>A <strong>neural network</strong> is a network or circuit of neurons, or in a modern sense, an <a href=\"https://en.wikipedia.org/wiki/Artificial_neural_network\">artificial neural network</a>, composed of <a href=\"https://en.wikipedia.org/wiki/Artificial_neuron\">artificial neurons</a> or nodes.<a href=\"https://en.wikipedia.org/wiki/Neural_network#cite_note-1\">[1]</a> Thus a neural network is either a <a href=\"https://en.wikipedia.org/wiki/Biological_neural_network\">biological neural network</a>, made up of biological neurons, or an artificial neural network, for solving <a href=\"https://en.wikipedia.org/wiki/Artificial_intelligence\">artificial intelligence</a> (AI) problems. The connections of the biological neuron are modeled in artificial neural networks as weights between nodes. A positive weight reflects an excitatory connection, while negative values mean inhibitory connections. All inputs are modified by a weight and summed. This activity is referred to as a linear combination. Finally, an activation function controls the <a href=\"https://en.wikipedia.org/wiki/Amplitude\">amplitude</a> of the output. For example, an acceptable range of output is usually between 0 and 1, or it could be −1 and 1.</p><p>These artificial networks may be used for <a href=\"https://en.wikipedia.org/wiki/Predictive_modeling\">predictive modeling</a>, <a href=\"https://en.wikipedia.org/wiki/Adaptive_control\">adaptive control</a> and applications where they can be trained via a dataset. Self-learning resulting from experience can occur within networks, which can derive conclusions from a complex and seemingly unrelated set of information.</p>', 'Soft Skills and Professional Development Course', NULL, '120', '112', '', 'Yes', 0, 27, 1, '2021-12-02 15:31:27', '2021-12-08 08:47:20', NULL, '20211202153127nn.png', 'Draft', 'anytime'),
(2, 'PEMIKIRAN KOMPUTASIONAL UNTUK PENYELESAIAN MASALAH MENGGUNAKAN PENGATURCARAAN ROBOTIK', '', '<p>Kursus<strong>&nbsp;</strong><i><strong>Pemikiran komputasional untuk penyelesaian masalah menggunakan pengaturcaraan robotik&nbsp;</strong></i>adalah sebuah e-kursus yang sesuai untuk dilaksanakan dua hari hingga &nbsp;satu minggu untuk memperkenalkan konsep asas pemikiran komputasional (<i>Computational Thinking</i> - CT). Kursus ini boleh dijadikan kursus pengenalan dan tambahan untuk pemahaman dan menggilap&nbsp;<strong>konsep CT</strong>&nbsp;dengan mengintegrasikannya dengan<strong>&nbsp;pendidikan robotik</strong>. Para peserta akan belajar dan mempraktikkan kemahiran CT dalam menyelesaikan masalah robot. Mereka juga berpeluang menerokai pengalaman pengaturcaraan robotik dan mencabar diri mereka dalam permainan dan perlumbaan robot dengan tahap kesukaran yang berbeza. Sebahagian aktiviti pengajaran dan pembelajaran dalam modul ini memerlukan peserta untuk&nbsp;<strong>mengatur cara sebuah</strong><i><strong>&nbsp;robot menjejak garisan</strong></i><strong>.</strong>&nbsp;Beberapa aktiviti dalam kursus ini menggunakan robot menjejak garisan bernama&nbsp;<strong>Robokar sebagai contoh</strong>. Walaubagaimana pun,&nbsp;<i>robot menjejak garisan</i><strong> yang lain juga boleh digunakan untuk mengikuti kandungan kursus ini.</strong></p>', 'Professional Certification Course', '1, 2', '120', 'Free', '', 'Yes', 1, 27, 2, '2021-12-07 15:55:12', '2021-12-09 11:19:54', NULL, '20211207155512pemikirankomputasional.jpg', 'Draft', 'choosedate'),
(3, 'Renewable Energy-Friends of the World', '', '<p>This subject introduces renewable energy resources, its basic concept, and contemporary renewable energy technology. It also covers sustainability and environmental issues. Design techniques for renewable energy systems are discussed in detail</p>', 'Course Academic', NULL, '14 Weeks', '100', '', 'Yes', 1, 27, 7, '2021-12-07 16:46:26', '2021-12-09 08:36:30', NULL, '20211207164626renewable_energy.jpg', 'Draft', 'anytime');
...
(24, 'edess@gmail.com', '$2y$10$b.ZHYzgR67vaGOKftIzdi.LLJWFLKSDWhbFaGP07pZOmPFfRk50MC', 6, '2021-09-20 16:03:20', '2021-11-08 15:40:18', NULL),
(25, 'tes111@yahoo.com', '$2y$10$OsXg56krhY6KLjE16ZijwuH2kygYk46p2Lj7zSuc.FLelsu5o.vG6', 6, '2021-09-20 16:05:50', NULL, '2021-09-28 10:50:27'),
...
(33, 'edess321@gmail.com', '$2y$10$HKLODTfLm3POWktupL7kruGw6TWqtHSharyv1OM17T8AXARC/73kC', 6, '2021-09-26 09:22:10', '2021-09-28 10:53:30', '2021-10-05 08:41:28'),
(34, 'hakim@yahoo.com', '$2y$10$1tWee10XQmzlGEFyi2jKOOju2J7aq3XYn2sY3RpgOhhWbmAF768XC', 9, '2021-09-27 11:06:39', NULL, NULL),
(36, 'integrasys@gmail.com', '$2y$10$mpA4nSe.TXq2rS2IOe840.36vA5WyBMJU/4PNuO6GazR9jb6Wv16K', 6, '2021-09-28 09:11:58', '2021-09-28 10:52:05', '2021-10-05 08:41:24'),
...
ALTER TABLE `course`
  ...
  ADD KEY `FK_course_created` (`course_created_by`),
  ADD KEY `FK_course_field` (`course_field_id`),
  ADD KEY `FK_course_institution` (`course_owner`);
...
--
ALTER TABLE `mc_course_credit_transfer`
  MODIFY `mccct_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `mc_enrolment_session`
--
ALTER TABLE `mc_enrolment_session`
  MODIFY `mces_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `mc_notes`
  MODIFY `mcn_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `mc_quiz_answer`
  MODIFY `mcqa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mc_quiz_question`
--
ALTER TABLE `mc_quiz_question`
  MODIFY `mcqq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `mc_video`
  MODIFY `mcv_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `course`
  ADD CONSTRAINT `FK_course_created` FOREIGN KEY (`course_created_by`) REFERENCES `institution` (`institution_id`),
  ADD CONSTRAINT `FK_course_field` FOREIGN KEY (`course_field_id`) REFERENCES `field` (`field_id`),
  ADD CONSTRAINT `FK_course_institution` FOREIGN KEY (`course_owner`) REFERENCES `institution` (`institution_id`);
...
--
ALTER TABLE `course_quiz`
  ADD CONSTRAINT `FK_cq_course` FOREIGN KEY (`cq_course_id`) REFERENCES `course` (`course_id`),
...
--
ALTER TABLE `course_quiz_answer`
  ADD CONSTRAINT `FK_cqa_cqq` FOREIGN KEY (`cqa_course_quiz_question_id`) REFERENCES `course_quiz_question` (`cqq_id`);

--
-- Constraints for table `course_quiz_question`
--
ALTER TABLE `course_quiz_question`
  ADD CONSTRAINT `FK_cqq_cq` FOREIGN KEY (`cqq_course_quiz_id`) REFERENCES `course_quiz` (`cq_id`);
...
--
ALTER TABLE `course_test`
  ADD CONSTRAINT `FK_ct_course` FOREIGN KEY (`ct_course_id`) REFERENCES `course` (`course_id`),
...
--
ALTER TABLE `course_test_answer`
  ADD CONSTRAINT `FK_cta_ctq` FOREIGN KEY (`cta_course_test_question_id`) REFERENCES `course_test_question` (`ctq_id`);

--
-- Constraints for table `course_test_question`
--
ALTER TABLE `course_test_question`
  ADD CONSTRAINT `FK_ctq_ct` FOREIGN KEY (`ctq_course_test_id`) REFERENCES `course_test` (`ct_id`);

--
-- Constraints for table `course_tutorial`
--
ALTER TABLE `course_tutorial`
  ADD CONSTRAINT `FK_ctu_course` FOREIGN KEY (`ctu_course_id`) REFERENCES `course` (`course_id`),
...
--
ALTER TABLE `course_tutorial_duedate`
  ADD CONSTRAINT `FK_ctud_ctu` FOREIGN KEY (`ctud_course_tutorial_id`) REFERENCES `course_tutorial` (`ctu_id`);
