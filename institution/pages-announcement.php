								...
								<div class="modal-body">
									<form action="" method="POST" enctype="multipart/form-data" id="announcement">
										...
										<div class="mb-3">
											...
											<textarea class="form-control" name="announcement_message" id="editornewmessage1"></textarea>

											<script>
												ClassicEditor
													.create(document.querySelector('#editornewmessage1'), {
								...
								<div class="card-body">
									...
									<table id="dataTableBasic" class="table table-hover display no-wrap table-sm shadow" style="width:100%">
										...
										<tbody class="align-middle">
											<?php
											$queryAnnouncement = $conn->query("SELECT * FROM announcement_institution WHERE announcement_created_by = '$institution_id';");
											$num = 1;
											...
											?>
													<tr>
														...
														<td class="text-center">
															...
															<a class="btn btn-danger btn-sm waves-effect waves-light" href="institution-function.php?delete_announcement=<?php echo $row->announcement_id; ?>" title="Delete Announcement" onClick="return deleteannouncement()">
