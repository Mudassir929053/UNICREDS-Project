                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->epq_status == 'Published') : ?>
                                                         <a href="institution-function.php?unpublish_cq=<?php echo $rows->epq_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->epq_status == 'Save Only') : ?>
                                                         <a href="institution-function.php?publish_cq=<?php echo $rows->epq_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                                                      ...
                                                      <table class="table table-bordered display no-wrap mb-0" style="width:100%">
                                                         ...
                                                         <tbody class="align-middle">
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>
                                                                  <center><?php if (($rows->epq_duration) != 0) {
