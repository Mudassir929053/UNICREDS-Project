                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <!-- <a class="btn btn-info waves-effect waves-light btn-sm shadow" href="pages-course-forum.php?cid=<?php echo $ep_id; ?>">
                                <i class="mdi mdi-comment-outline fs-5 me-1"></i>Forum</a> -->
                                <a class="btn btn-info waves-effect waves-light btn-sm shadow" href="pages-employability-program-content-edit.php?cid=<?php echo $ep_id; ?>">
                                    <i class="fe fe-edit fs-5 me-1"></i>Edit</a>
                                <a class="btn btn-warning waves-effect waves-light btn-sm shadow text-dark" href="pages-employability-program-content.php?cid=<?php echo $ep_id; ?>">
