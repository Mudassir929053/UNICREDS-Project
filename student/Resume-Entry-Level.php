	...
	<div class="resume  wrapper  " >
		<div class="resume shadow-lg page" id="pdf">
			<div class="left bg-warning">
				...
				<h3><div class="name"style="color:white;">
						...
						<ul>
							<li>
								<div class="">
									...
									<div class="text" style="color:white;"><?= $skill["skill_name"] ?></div>
					...
					<?php
						...
						<ul>
							<li>
								<div class="">
									<!-- <div class="icon"><i class="fab fa-html5"></i></div> -->
									<div class="text" style="color:white;"><?= $suHobbyInfo[$i]["sued_hobby_name"] ?></div>
