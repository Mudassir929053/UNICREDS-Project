...
if (isset($_GET["pt_id"])) {
    ...
    if ($fetchQuizQnA !== NULL) {
        ...
        foreach ($fetchQuizQnA as $val) {
            $data["qq_id"] = $val["ptq_id"];
            $data["qa_id"] = $val["ptq_id"];
            $data["qq_type"] = $val["ptq_type"];
            $data["qq_figure"] = $val["question_img"] !== NULL ? "../assets/images/question/" . $val["question_img"] : $val["question_img"];
            $data["qq_question"] = $val["ptq_question"];
            $data["qa_1"] = $val["ptq_option1"];
            $data["qa_2"] = $val["ptq_option2"];
            $data["qa_3"] = $val["ptq_option3"];
            $data["qa_4"] = $val["ptq_option4"];
            $data["qa_5"] = $val["ptq_option5"];
        ...
        header("Location: quiz-attempt-question.php?ep_id=$subjID&quiz_id=$quizID");
    }
}
                ...
                <div class="row">
                    ...
                    <div id="questionsList" class="col-xl-9 col-lg-9 col-md-12 col-12">
                        ...
                        foreach ($quizQnA as $data) {
                            ...
                            if ($data["qq_type"] === "Multiple Choice") {
                        ?>
                                <!-- Question Type 1 -->
                                ...
                                <div class="card mb-3 <?= $collapse ?>" id="question<?= $i + 1 ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="justify-content-between align-items-center text-dark">
                                            ...
                                            <figure class="w-75 h-75 mb-3 <?= $data["qq_figure"] === NULL ? "collapse" : "" ?>">
                                                    <img src="<?= $data["qq_figure"] ?>" alt="" class="w-100 h-100 border border-primary">
                                                    <figcaption class="text-center mt-1 <?= $data["qq_figcaption"] === NULL ? "collapse" : "" ?>"><?= $data["qq_figcaption"] ?></figcaption>
                                                </figure>
                                            </div>
                                            <p class="my-4 fs-4">
                                                <?= $data["qq_question"] ?>
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center">
                                                    <input type="radio" id="q<?= $i + 1 ?>Answer1" data-id="qnav-q<?= $i + 1 ?>" class="btn-check" name="q<?= $i + 1 ?>Answer" value="<?= $data["qa_1"] ?>" autocomplete="off">
                                                    <label for="q<?= $i + 1 ?>Answer1" class="btn btn-outline-success py-1 px-2">A</label>
                                                    <p class="ms-3 fs-5 m-0"><?= $data["qa_1"] ?></p>
                                                </div>
                                                <div class="form-check d-flex align-items-center mt-2">
                                                    <input type="radio" id="q<?= $i + 1 ?>Answer2" data-id="qnav-q<?= $i + 1 ?>" class="btn-check" name="q<?= $i + 1 ?>Answer" value="<?= $data["qa_2"] ?>" autocomplete="off">
                                                    <label for="q<?= $i + 1 ?>Answer2" class="btn btn-outline-success py-1 px-2">B</label>
                                                    <p class="ms-3 fs-5 m-0"><?= $data["qa_2"] ?></p>
                                                </div>
                                                <div class="form-check d-flex align-items-center mt-2">
                                                    <input type="radio" id="q<?= $i + 1 ?>Answer3" data-id="qnav-q<?= $i + 1 ?>" class="btn-check" name="q<?= $i + 1 ?>Answer" value="<?= $data["qa_3"] ?>" autocomplete="off">
                                                    <label for="q<?= $i + 1 ?>Answer3" class="btn btn-outline-success py-1 px-2">C</label>
                                                    <p class="ms-3 fs-5 m-0"><?= $data["qa_3"] ?></p>
                                                </div>
                                                <div class="form-check d-flex align-items-center mt-2">
                                                    <input type="radio" id="q<?= $i + 1 ?>Answer4" data-id="qnav-q<?= $i + 1 ?>" class="btn-check" name="q<?= $i + 1 ?>Answer" value="<?= $data["qa_4"] ?>" autocomplete="off">
                                                    <label for="q<?= $i + 1 ?>Answer4" class="btn btn-outline-success py-1 px-2">D</label>
                                                    <p class="ms-3 fs-5 m-0"><?= $data["qa_4"] ?></p>
                                                </div>
                                                <input type="hidden" name="qq_<?= $i + 1 ?>" value="<?= $data["qq_id"] ?>">
                                                <input type="hidden" name="qa_<?= $i + 1 ?>" value="<?= $data["qa_id"] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            <?php
                            } elseif ($data["qq_type"] === "True/False") {
                            ?>
                                <!-- Question Type 5 -->
                                <!-- *** True/False question -->
                                <div class="card mb-3 <?= $collapse ?>" id="question<?= $i + 1 ?>">
                            ...
                            <?php
                            }  elseif ($data["qq_type"] === "Disagree/Agree") {
                                ?>
                                        <!-- Question Type 1 -->
                                        <!-- *** Multiple-choice question -->
                                        <div class="card mb-3 <?= $collapse ?>" id="question<?= $i + 1 ?>">
                                            ...
                                            <div class="card-body">
                                                <div class="justify-content-between align-items-center text-dark">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-check d-flex align-items-center mt-2">
                                                            <input type="radio" id="q<?= $i + 1 ?>Answer5" data-id="qnav-q<?= $i + 1 ?>" class="btn-check" name="q<?= $i + 1 ?>Answer" value="<?= $data["qa_5"] ?>" autocomplete="off">
                                                            <label for="q<?= $i + 1 ?>Answer5" class="btn btn-outline-success py-1 px-2">D</label>
                                                            <p class="ms-3 fs-5 m-0"><?= $data["qa_5"] ?></p>
                                                        </div>
                                                        <input type="hidden" name="qq_<?= $i + 1 ?>" value="<?= $data["qq_id"] ?>">
                                                        <input type="hidden" name="qa_<?= $i + 1 ?>" value="<?= $data["qa_id"] ?>">
                                                    </div>
                                        ...
                                        <div class="justify-content-between align-items-center text-dark">
                                            ...
                                            <div class="mb-3 fs-4">
                                                <div class="form-check d-flex align-items-center">
                                                    ...
                                                    <textarea type="hidden" id="q<?= $i + 1 ?>Answer1"  data-id="qnav-q<?= $i + 1 ?>" name="q<?= $i + 1 ?>Answer" placeholder="write your answer here" class=" border-success" value="" autocomplete="off"></textarea>
                                                </div>
                    ...
                    <input type="hidden" name="qq_total" value="<?= count($quizQnA) ?>">
