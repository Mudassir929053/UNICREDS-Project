                    ...
                    <div class="card mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <?php
                                    $queryforummessageinstructor = $conn->query("SELECT * FROM forum_post_course
                                    ...
                                    $num = 1;
                                    if (mysqli_num_rows($queryforummessageinstructor) > 0) {
                                        while ($rows = mysqli_fetch_object($queryforummessageinstructor)) {
                                            ...
                                            <div class="card-body">
                                                <div class="d-flex flex-start align-items-center">
                                                    ...
                                                    ?>
                                                        ...
                                                        <?php } elseif ($rows->user_role_id == '7') {  ?>
                                                            ...
                                                            <?php } elseif ($rows->user_role_id == '10') { ?>
                                                                ...
                                                                <p class="text-muted small mb-0">
                                                                    <?php echo date('j F Y H:i:s', strtotime($rows->fpc_created_date)) ?>
                                                                </p>
                                                                </div>
                                                            </div>
                                                            <div class="m-4 mb-0">
                                                                <h4><?php echo $rows->fpc_message; ?></h4>
                                                            </div>
                                                        ...
                                                        <?php
                                                        $queryforummessagestudent = $conn->query("SELECT * FROM forum_post_course
                                                        ...
                                                        $num = 1;
                                                        if (mysqli_num_rows($queryforummessagestudent) == 0) {
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-success btn-sm" name="add_forum_reply_course">Submit</button>
                                            </div>
                                        </div>
                                    </div>
                                    </form>
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php
                                        $queryforummessagestureplies = $conn->query("SELECT * FROM forum_post_course
                                                               LEFT JOIN user ON fpc_student = user.user_id
                                                               LEFT JOIN student_university ON user.user_id = student_university.su_user_id 
                                                               WHERE fpc_topic_id = '$topic_id' 
                                                               AND fpc_instructor IS NULL;");
                                        ...
                                        $num = 1;
                                        if (mysqli_num_rows($queryforummessagestureplies) > 0) {
                                            while ($rows = mysqli_fetch_object($queryforummessagestureplies)) {
                                                        ...
                                                        <div class="mt-1 m-2">
                                                            <span class="dropdown dropstart">
                                                                ...
                                                                <span class="dropdown-menu" aria-labelledby="courseDropdown"><span class="dropdown-header">Action</span>
                                                                    ...
                                                                    <a class="dropdown-item" href="function/student-function.php?delete_reply_course=<?php echo $rows->fpc_id; ?>&topic_id=<?php echo $rows->fpc_topic_id; ?>&suid=<?php echo $get_userID; ?>" title="Delete Course" onclick="return deletereply()">
                                                        ...
                                                        <div class="modal fade" id="editreply<?php echo $rows->fpc_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editreplymodal" aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                                                                        <button type="submit" class="btn btn-success btn-sm" name="edit_forum_reply_course">Submit</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            </form>
