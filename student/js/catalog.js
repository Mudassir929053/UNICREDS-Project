$(document).ready(function() {
    ...
    const coursePath = "/unicreds/student/course-lists.php";
    const mcPath = "/unicreds/student/micro-creds-lists.php";
    const epPath = "/unicreds/student/ep-list.php";

    var getPath = window.location.pathname;
    var curr_path = "";

    // Check if this is course or micro-credential or employability list page.
