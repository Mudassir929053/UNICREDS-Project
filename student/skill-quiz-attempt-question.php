...
if (isset($_GET["st_id"])) {
    ...
    $subjID = $_GET["st_id"];
    $skData = $skInfo->fetch_skillassessment($subjID);
    // --- fetch the micro-credential's quiz informations and questions and its answers choices.
    $fetchQuizInfo = $skInfo->fetch_quiz_info($quizID);
    $fetchQuizQnA = $skInfo->fetch_quiz_QnA($quizID);
    ...
    if ($fetchQuizQnA !== NULL) {
        ...
        foreach ($fetchQuizQnA as $val) {
            $data["qq_id"] = $val["stq_id"];
            $data["qa_id"] = $val["stqa_id"];
            $data["qq_type"] = $val["stq_type"];
            $data["qq_figure"] = $val["stq_fileupload"];
            // $data["qq_figcaption"] = $val["mcqq_figure_caption"];
            $data["qq_question"] = $val["stq_question"];
            $data["qa_1"] = $val["stqa_answer1"];
            $data["qa_2"] = $val["stqa_answer2"];
            $data["qa_3"] = $val["stqa_answer3"];
            $data["qa_4"] = $val["stqa_answer4"];
        ...
        header("Location: skill-quiz-attempt-main.php?st_id=$quizID");
    }
}
...
<body>
    ...
    <form id="qnaForm" action="function/quiz-test-attempt1.php" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div id="questionsList" class="col-xl-9 col-lg-9 col-md-12 col-12">
                        ...
                        ?>
                            ...
                            <?php
                            } else if ($data["qq_type"] === "fileupload") {
                            ?>
                                <!-- Question Type 5 -->
                                <!-- *** True/False question -->
                                <div class="card mb-3 <?= $collapse ?>" id="question<?= $i + 1 ?>">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex justify-content text-dark">
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check d-flex align-items-center mt-2">
                                                    <span class="label label-success">Please Download this file and upload your answer file below</span>

                                                    <a class="btn waves-effect waves-light btn-sm" href="../assets/attachment/skillfileupload/<?= $data["qq_figure"] ?>" target="_blank" data-bs-toggle="tooltip" data-placement="top" title="View Attachment"> <span class="hidden-xs-down"><i class="text-primary mdi mdi-folder-multiple-image fs-4" aria-hidden="true"></i> Attachment </span></a>
                                                ...
                                                <div class="form-check d-flex align-items-center mt-2">
                                                    ...
                                                    <div class="custom-file">
                                                        <div class="input-group mb-1 btn  float-right bg-primary text-light ">
                                                            <input type="file" accept="application/pdf,application/vnd.ms-excel" name="q<?= $i + 1 ?>Answer"id="susatrv_fileupload<?= $i + 1 ?>">
                    ...
                    <input type="hidden" name="st_id" value="<?= $quizID ?>">
                    ...
                    <div class="col-lg-3 col-md-12 col-12 accordion" id="accordionQNav">
                        <div class="card border-0 mb-3">
                            ...
                            <!-- Card body -->
                            <div class="p-2 collaps" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionQNav">
