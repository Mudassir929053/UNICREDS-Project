  ...
  <div class="resume  shadow-lg p-3  bg-body rounded page" id="pdf">
    ...
    <div class="resume_right">
      <div class="resume_item resume_namerole">
        <div class="name">
          <h4><?= $suInfoRow["su_fname"] . " " . $suInfoRow["su_lname"] ?></h4>
        </div>
          ...
          ?>
            <div>
              <li>
                ...
                <div class="content">
                  <p>
                  <h5><?= $suLanguageInfo[$i]["sued_language_name"] ?><h5>
                      </p>
                      <p class="desc"><?= strip_tags($suLanguageInfo[$i]["sued_job_description"]) ?></p>
                </div>
      ...
      ?>
        ...
        <div class="resume_item resume_education">
          ...
          ?>
            <div>
              <li>
                <div style="color:black;"> <?= $suEduInfo[$i]["sued_course_title"] ?></div>
        ...
        ?>
          ...
          <div class="resume_item resume_education">
            ...
            ?>
              <div>
                <li>
                  <div style="color:black;"> <?= $suReferenceInfo[$i]["sued_reference"] ?></div>
