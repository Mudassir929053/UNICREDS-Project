...
<!-- Favicon icon-->
<link rel="shortcut icon" type="image/x-icon" href="../assets/images/logo/unicreds.ico">
...
<link rel="stylesheet" href="../assets/css/theme.min.css">
  ...
  <title>UNICREDS - Student</title>
  <style>
    
	.nav-tabs {
		background-color: transparent;
		/* Set transparent background for the tabs */
	}
	...
	.nav-tabs .nav-link.active {
		...
		/* Set the bottom border color for the active tab */
	}
