        ...
        <img src="<?= $suInfoRow["su_profile_pic"] !== NULL ? "../assets/images/avatar/" . $suInfoRow["su_profile_pic"] : "../assets/images/avatar/avatardefault.png" ?>"
              ...
              <?php
								...
								<div class="li_wrap">
									...
									<div class="text"><?= $suExpInfo[$i]["country_name"] ?>, <?= $suExpInfo[$i]["state_name"] ?>, <?= $suExpInfo[$i]["city_name"] ?></div>
								</div>
							</li>
						</ul>
					</div>
							...
							<ul>
								<li>
									<div class="li_wrap">
										...
										<div class="date">
                    <?= date_format(date_create($suExpInfo[$i]["sued_start_date"]), "M-Y") ?> -  <?= $suExpInfo[$i]["sued_job_status"] === "Current" ? "-" : date_format(date_create($suExpInfo[$i]["sued_end_date"]), "M_Y") ?>
										</div>
										<div class="info">
											<p class="info_title">
                      ...
                      <?= strip_tags($suExpInfo[$i]["sued_description"]) ?>
											</p>
										</div>
