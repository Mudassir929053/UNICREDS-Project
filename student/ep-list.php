...
<body>
    ...
    $totalEP = 0;
    if ($epInfo->fetch_employability_programs() !== NULL) {
        $totalEP = count($epInfo->fetch_employability_programs());
    } else {
        $totalEP = 0;
    }
    ?>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                    <div>
                        <h1 class="mb-0 text-white display-4">Employability Programs</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                    ...
                    <div class="row d-lg-flex justify-content-between align-items-center">
                        <div class="col-md-6 col-lg-8 col-xl-9 ">
                            <h4 class="mb-3 mb-lg-0">
                                Displaying <span id="displayCount"><?= $totalEP ?></span> out of <span id="totalCount"><?= $totalEP ?></span> Employability Programs
                            </h4>
                        </div>
                ...
                <div id="filter" class="col-xl-3 col-lg-3 col-md-4 col-12 mb-4 mb-lg-0">
                    ...
                    <div class="card">
                        ...
                        <!-- Institutions -->
                        <!-- Display the course category checkboxes -->
                        <div class="card-body border-top p-0 mb-2">
                            <span class="dropdown-header px-0 mb-0 mt-4 ms-4">category</span>
                            <div class="d-flex w-auto" style="max-height: 300px;">
                                <div id="course" class="d-flex flex-column py-2 overflow-auto pe-1">
                                    <?php
                                    $courseInfo = $conn->query("SELECT DISTINCT ep_category FROM `employability_program`;");
                                    $courseInfoNumRows = mysqli_num_rows($courseInfo);

                                    for ($i = 0; $i < $courseInfoNumRows; $i++) {
                                        $courseInfoRow = mysqli_fetch_object($courseInfo);
                                    ?>
                                        <!-- Checkbox -->
                                        <div class="d-block">
                                            <div class="form-check mb-1 ms-4 me-2">
                                                <input type="checkbox" class="form-check-input" id="inst-<?= $courseInfoRow->ep_category ?>" name="inst" value="<?= $courseInfoRow->ep_category ?>">
                                                <label class="form-check-label" for="inst-<?= $courseInfoRow->ep_category ?>"><?= $courseInfoRow->ep_category ?></label>
                                            </div>
                                        </div>
                                    <?php
                                    }
                        ...
                        <!-- Retrieve the selected courses in PHP -->
