              ...
              <div class="row">
                <div class="col-md-12 bg-light text-right">
                  ...
                  <a href="pages-career_readiness-skill-response.php" class="btn btn-outline-primary btn-sm shadow">View Response <span class="badge bg-danger text-light rounded-pill"><?php
                                                                                                 ...
                                                                                                 WHERE st_created_by='$get_userID' AND sstr.susatrv_st_test_question_id=stq.stq_id  AND sstr.susatrv_fileupload !=''   AND sstr.susatrv_answer_status IS NULL
                                                                                                 GROUP BY st.st_id";
                            ...
                            <td class="text-center">
                              ...
                              <a class="me-1 text-inherit" href="#">
                                <?php if ($rows->st_status == 'Published') : ?>
                                  <a class="btn btn-sm btn-warning shadow" href="industry-function.php?unpublish_crt=<?php echo $rows->st_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                    <!-- <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i> -->
                                    Unpublish
                                  </a>
                                <?php endif ?>
                                <?php if ($rows->st_status == 'Save Only') : ?>
                                  <a class="btn btn-sm btn-success shadow" href="industry-function.php?publish_crt=<?php echo $rows->st_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                            ...
                            <td class="text-muted px-4 py-3 align-middle border-top-0">
                              <span class="dropdown dropstart">
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown"><span class="dropdown-header">Action</span>
                                  ...
                                  <a class="dropdown-item" href="industry-function.php?delete_crt=<?php echo $rows->st_id; ?>" title="Delete Course" onclick="return deletecourse()"><i class="fe fe-trash dropdown-item-icon text-danger"></i>Delete</a>
                                  <a class="dropdown-item" href="pages-career_readiness-skill-assessment-quiz.php?st_id=<?php echo $rows->st_id ?>" title="Delete Course"><i class="fe fe-eye dropdown-item-icon text-danger"></i>Questions</a>
