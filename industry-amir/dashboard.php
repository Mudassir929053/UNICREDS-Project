                                    ...
                                    <div class="card mb-4" style="background-image: url('../assets/images/background/bg-gradient-green.jpg');">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <h2 class="fw-bold mb-1">
                                                71 &nbsp;<span class="fw-bold mb-1 text-success fs-3"> APPROVED </span>&nbsp;
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex align-items-center justify-content-between mb-3 lh-1">
                                                ...
                                                <div>
                                                    ...
                                                    <!-- <span class=" fas fa-book-open fs-3 text-warning"></span> -->
                                                </div>
                                            </div>
                                            <h2 class="fw-bold mb-1">
                                                56 &nbsp;<span class="fw-bold mb-1 text-danger fs-3"> TO REVIEW </span>&nbsp;
                                    ...
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body" style="height: 500px; overflow-y: auto;">
                                            ...
                                            $sqlAnnouncement = $conn->query("SELECT *
                                                                                ...
                                                                                WHERE announcement_receiver LIKE '%3%'
