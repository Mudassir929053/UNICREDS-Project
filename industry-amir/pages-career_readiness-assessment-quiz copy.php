...
<body>
    ...
    <div id="db-wrapper">
        ...
        <link rel="stylesheet" href="..\assets\css\style copy 2.css">
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                    ...
                                    <?php $queryquizquestion = $conn->query("SELECT * from  psychometric_test_section GROUP BY pts_name; ");
                                    ...
                                    ?>
                                            ...
                                            <ul class="m-d expand-list">
                                                <li data-md-content="10000" class="border border-info shadow-lg p-3  rounded rounded-0 m-2 py-3 pb-3 px-5 bg-gradiant" style="background-color:hsl(35.7, 100%, 57.5%)">
                                                    ...
                                                    <span class="sectiond">
                                                        <a href="#" style=" color:#14A44D;" data-bs-toggle="modal" data-bs-target="#modaleditnote<?php echo  $rows['pts_id']; ?>">
                                                                ...
                                                                <div class="alert alert-light" role="alert">
                                                                        ...
                                                                        <div class="btn-group btn-sm justify-content-md-end mt-0 mb-5" role="group" aria-label="Button group with nested dropdown ">
                                                                            ...
                                                                            <div class="btn-group btn-sm" role="group">
                                                                                ...
                                                                                <ul class="dropdown-menu border" aria-labelledby="btnGroupDrop1">
                                                                                    ...
                                                                                    <li><a class="dropdown-item font-weight-bold" data-bs-toggle="modal" data-bs-target="#addMulti" href="#">Choice</a></li>

                                                                                    <li><a class="dropdown-item font-weight-bold" data-bs-toggle="modal" data-bs-target="#addText" href="#">Text</a></li>

                                                                                    <li><a class="dropdown-item font-weight-bold" data-bs-toggle="modal" data-bs-target="#addLikert" href="#">Likert</a></li>

                                                                                    <li><a class="dropdown-item font-weight-bold" data-bs-toggle="modal" data-bs-target="#addTF" href="#">True/False</a></li>
                                                                    ...
                                                                    <ul class="m-d expand-list">
                                                                        ...
                                                                        ?>
                                                                                ...
                                                                                <li data-md-content="10000" class="border border-info rounded-0 mx-2 py-3 pb-0 mb-2 px-5 bg-light">
                                                                                    ...
                                                                                    <div class="content">
                                                                                        ...
                                                                                        <?php } elseif ($rows1['question_img'] == NULL) { ?>
                                                                                            <div class="row ">
                                                                                            </div>
                                                                                            <?php   ?>
                                                                                        <?php } elseif ($rows1['question_img'] == $S) { ?>
                                                                                            <div class="row ">
                                                                                            </div>
                                                                                        <?php  } ?>
                                    ...
                                    <div class="modal fade" id="addMulti" tabindex="-1" role="dialog" aria-labelledby="questionmodal" aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div>
                                                    <input type="hidden" value="<?php echo $pt_id; ?>">
                                                </div>
                                                <div class="modal-body">
                                                    <form action="" method="POST" enctype="multipart/form-data" id="addMulti" autocomplete="off">
                                                        ...
                                                        <div class="mb-3 col-12 float-start">
                                                            ...
                                                            <script>
                                                                ClassicEditor
                                                                    .create(document.querySelector('#editmcquestion'), {})
                                                                    .then(editor => {
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-success btn-sm" name="add_Career_Readiness_quiz_question">Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                        </form>
                                    ...
                                    <!-- Start Modal Page For Add Multiple Choice Question -->
                                    <div class="modal fade" id="addTF" tabindex="-1" role="dialog" aria-labelledby="questionmodal" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="POST" enctype="multipart/form-data" id="addTF" autocomplete="off">
                                                        ...
                                                        <input type="hidden" name="pt_id" value="<?php echo $pt_id; ?>">
                                                        <input type="hidden" name="pts_id" value="4">
                                                        <div class="mb-3">
                                                        </div>
                                                        ...
                                                        <div class="mb-3 col-12 float-start">
                                                            ...
                                                            <script>
                                                                ClassicEditor
                                                                    .create(document.querySelector('#editTFquestion'), {})
                                                                    .then(editor => {
                                                                        window.editor = editor;
                                                                    })
                                                                    .catch(err => {
                                    ...
                                    <div class="modal fade" id="addText" tabindex="-1" role="dialog" aria-labelledby="questionmodal" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="POST" enctype="multipart/form-data" id="addText" autocomplete="off">
                                                        ...
                                                        <input type="hidden" name="pt_id" value="<?php echo $pt_id; ?>">
                                                        <input type="hidden" name="pts_id" value="2">
                                                        <div class="mb-3">
                                                        </div>
                                                        ...
                                                        <div class="mb-3 col-12 float-start">
                                                            ...
                                                            <script>
                                                                ClassicEditor
                                                                    .create(document.querySelector('#addtextquestion'), {})
                                                                    .then(editor => {
                                                                        window.editor = editor;
                                                                    })
                                                                    .catch(err => {
                                    ...
                                    <div class="modal fade" id="addLikert" tabindex="-1" role="dialog" aria-labelledby="questionmodal" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="POST" enctype="multipart/form-data" id="addLikert" autocomplete="off">
                                                        ...
                                                        <input type="hidden" name="pt_id" value="<?php echo $pt_id; ?>">
                                                        <input type="hidden" name="pts_id" value="3">
                                                        <div class="mb-3">
                                                        </div>
                                                        ...
                                                        <div class="mb-3 col-12 float-start">
                                                            ...
                                                            <script>
                                                                ClassicEditor
                                                                    .create(document.querySelector('#editnewlikertquestion'), {})
                                                                    .then(editor => {
                                                                        window.editor = editor;
                                                                    })
                                                                    .catch(err => {
                                                                ...
                                                                <div class="table-responsive">\
                                                                    <table class="table no-wrap table-hover">\
                                                                        ...
                                                                        <tbody>\
                                                                            <tr>\
                                                                                <td>\
                                                                                    <input type="text" name="option5" placeholder="Option A" value="True" class="form-control form-control-sm">\
                                                                                </td>\
                                                                                <td>\
                                                                                    <input type="text" name="option6" placeholder="Option B" value="False" class="form-control form-control-sm">\
                                                                                </td>\
                                                                            </tr>\
                                                                        </tbody>\
                                                                    </table>\
