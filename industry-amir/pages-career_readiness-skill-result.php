            ...
            <div class="row">
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a class="btn btn-sm btn-secondary waves-effect waves-light" href="pages-career_readiness-skill-response.php">
                                ...
                                <a class="text-inherit">
                                  <div class="d-lg-flex align-items-center">
                                    ...
                                    <div class="ms-lg-3 mt-2 mt-lg-0">
                                      ...
                                      <span class="text-inherit "><?php echo date('j F Y H:i:s', strtotime($rows->susatqrs_attempted_date)) ?> </span>
                                    </div>
                                  </div>
                                </a>
                              </td> -->
