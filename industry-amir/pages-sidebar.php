...
<nav class="navbar-vertical navbar">
    <div class="nav-scroller">
        ...
        <ul class="navbar-nav flex-column" id="sideNavbar">
            ...
            <!-- Nav item -->
            <li class="nav-item">
                <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#navCareerReadiness" aria-expanded="false" aria-controls="navCareerReadiness">
                    <i class="nav-icon fas fa-users me-2 fs-5"></i> Career Readiness
                </a>
                <div id="navCareerReadiness" class="collapse <?php
            ...
            <!-- Nav item -->
            <li class="nav-item">
                <a class="nav-link" href="#" data-bs-toggle="collapse" data-bs-target="#navUsers" aria-expanded="false" aria-controls="navUsers">
                    <i class="nav-icon fas fa-users me-2 fs-5"></i> Users
                </a>
                <div id="navUsers" class="collapse <?php
                                                    if ($_SESSION['pages'] == 'staff' || $_SESSION['pages'] == 'institution' || $_SESSION['pages'] == 'industry') {
                                                        echo ('show');
                                                    } ?>" data-bs-parent="#sideNavbar">
                    <ul class="nav flex-column">
