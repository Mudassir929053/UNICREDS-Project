                    ...
                    <div class="col-lg-12 col-md-12 col-12">
                        ...
                        <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                            <div class="mb-3 mb-md-0">
                                <h1 class="mb-1 h2 fw-bold">Staff</h1>
                                <!-- Breadcrumb -->
                            ...
                            <div>
                                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#addstaff">Add Staff</button>
                            </div>
                        </div>
                    </div>
                    <!-- Start Modal Page -->
                    <div class="modal fade" id="addstaff" tabindex="-1" role="dialog" aria-labelledby="staffmodal" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staffmodal">Register Staff</h5>
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="staffForm">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" id="institution_email" name="institution_email" class="form-control" placeholder="name@example.com" required>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <span style="vertical-align: middle;" class="<?php if ($rows->institution_status == 'Active') {
                                                                                                                echo "badge bg-success";
                                                                                                            } else {
                                                                                                                echo "badge bg-danger";
                                                                                                            } ?>"><?php echo $rows->institution_status; ?>
                                                            </span>
                                                        </td>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="mb-3">
                                                                                ...
                                                                                <select class="selectpicker" data-live-search="true" data-width="100%" name="new_institution_university_id" id="new_inst_uni_id<?php echo $rows->institution_id; ?>">
                                                                                    ...
                                                                                    ?>
                                                                                            <option value="<?php echo $rowuni->university_id; ?>" <?php if ($rows->institution_university_id == $rowuni->university_id) {
                                                                                                                                                        echo "selected";
                                                                                                                                                    } else {
                                                                                                                                                    } ?>><?php echo $rowuni->university_name; ?></option>
