                                                        ...
                                                        <div class="card card-body">
                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="mb-5">
                                                                    ...
                                                                    <div>
                                                                        <input type="radio" class="btn-check" name="new_company_size" 
                                                                        value="Up to 10 employees" id="Up to 10 employees" <?php if ($rows->ii_company_size == "Up to 10 employees") {
                                                                                                                                                    echo "checked";
                                                                                                                                                }?>>
                                                                        <label class="btn btn-outline-primary" for="Up to 10 employees">Up to 10 employees</label>

                                                                        <input type="radio" class="btn-check" name="new_company_size" 
                                                                        value="10-50 employees" id="10-50 employees" <?php if ($rows->ii_company_size == "10-50 employees") {
                                                                                                                                                    echo "checked";
                                                                                                                                                }?>>
                                                                        <label class="btn btn-outline-primary" for="10-50 employees">10-50 employees</label>

                                                                        <input type="radio" class="btn-check" name="new_company_size" 
                                                                        value="50-250 employees" id="50-250 employees" <?php if ($rows->ii_company_size == "50-250 employees") {
                                                                                                                                                    echo "checked";
                                                                                                                                                }?>>
                                                                        <label class="btn btn-outline-primary" for="50-250 employees">50-250 employees</label>

                                                                        <input type="radio" class="btn-check" name="new_company_size" 
                                                                        value="More than 250 employees" id="More than 250 employees" <?php if ($rows->ii_company_size == "More than 250 employees") {
                                                                                                                                                    echo "checked";
                                                                                                                                                }?>>
