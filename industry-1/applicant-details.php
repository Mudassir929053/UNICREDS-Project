                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                ?>
                                                                                        ...
                                                                                        <tbody>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="text-center"><?php echo $num++; ?></td>
                                                                                                <td><?php echo $rows->sued_job_title; ?></td>
                                                                                                <td><?php echo $rows->sued_company_name; ?></td>
                                                                                                <td><?php echo date('j/m/Y', strtotime($rows->sued_start_date)); ?></td>
                                                                                                <?php if ($rows->sued_job_status == "Past") { ?>
                                                                                                    <td><?php echo date('j/m/Y', strtotime($rows->sued_end_date)); ?></td>
                                                                                                <?php } else { ?>
                                                                                                    <td><?php echo $rows->sued_job_status ?></td>
                                                                                                <?php } ?>
                                                                                            </tr>
                                                        ...
                                                        <td class="text-muted px-4 py-3 text-center border-top-0">
                                                            <span class="dropdown dropstart">
                                                                <a class="text-muted text-decoration-none" href="#" role="button" id="courseDropdown" data-bs-toggle="dropdown" data-bs-offset="-20,20" aria-expanded="false">
                                                                    ...
                                                                    <a class="dropdown-item" href="#">Invite for interview</a>
                                                                    <a class="dropdown-item" href="#">Keep in view</a>
                                                                    <a class="dropdown-item" href="#">Reject Applicant</a>
