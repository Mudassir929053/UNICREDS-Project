...
">
                                                                <span class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree<?php echo $rows->ltcp_id; ?>" aria-expanded="false" aria-controls="flush-collapseThree">
                                                                    ...
                                                                    <span style="position:sticky;left:1630px; ">
                                                                        ...
                                                                        <a href="industry-function.php?delete_language_test_question_for_passage=<?php echo $rows->ltq_id; ?>&delete_language_test_answer_for_passage=<?php echo $rows->lta_id; ?> &delete_language_test_passage=<?php echo $rows->ltcp_id; ?>" class="me-1 text-inherit" onclick="return deletequestion1()" style="margin-left: 10px;">
