                ...
                <div class="card-body">
                  <table id="dataTableBasic" class="table table-hover table-sm display no-wrap shadow" style="width:100%">
                    ...
                    <tbody class="align-middle">
                      ...
                      <?php
                      $querycq = $conn->query("SELECT * FROM psychometric_test WHERE pt_deleted_date IS NULL ");
                      // $checkuserrow = $conn->query("SELECT industry_user_id  FROM industry WHERE industry_id  = '$industry_id '");
                      // $rowReadUser = $checkuserrow->fetch_object();
                      // $get_userID = $rowReadUser->industry_user_id;                 
                      // $querycq = $conn->query("SELECT * FROM `psychometric_test` where  pt_created_by='$get_userID';");
                      $num = 1;
                                ...
                                <div class="d-lg-flex align-items-center">
                                  ...
                                  <div class="ms-lg-3 mt-2 mt-lg-0">
                                    <a data-bs-toggle="tooltip" title="View Details" href="pages-career_readiness-assessment-quiz.php?pt_id=<?php echo $rows->pt_id; ?>">
                                      <h4 class="mb-1 text-uppercase text-primary-hover">
                            ...
                            <td class="text-center">
                              ...
                              <a class="me-1 text-inherit" href="#">
                                <?php if ($rows->pt_status == 'Published') : ?>
                                  <a class="btn btn-sm btn-warning shadow" href="industry-function.php?unpublish_crt=<?php echo $rows->pt_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                    <!-- <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i> -->
                                    Unpublish
                                  </a>
                                <?php endif ?>
                                <?php if ($rows->pt_status == 'Save Only') : ?>
                                  <a class="btn btn-sm btn-success shadow" href="industry-function.php?publish_crt=<?php echo $rows->pt_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                            ...
                            <td class="text-muted px-4 py-3 align-middle border-top-0">
                              <span class="dropdown dropstart">
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown"><span class="dropdown-header">Action</span>
                                  ...
                                  <a class="dropdown-item" href="industry-function.php?delete_crt=<?php echo $rows->pt_id; ?>" title="Delete Course" onclick="return deletecourse()"><i class="fe fe-trash dropdown-item-icon text-danger"></i>Delete</a>
                                  <a class="dropdown-item" href="pages-career_readiness-assessment-quiz.php?pt_id=<?php echo $rows->pt_id ?>" title="Delete Course"><i class="fe fe-trash dropdown-item-icon text-danger"></i>Questions</a>
              ...
              <div class="modal fade" id="modaleditquiz<?php echo $rows->pt_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editmcq" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                      <button type="submit" class="btn btn-success btn-sm" name="edit_career_readiness_test">Update</button>
                    </div>
                    </form>
                  </div>
                </div>
