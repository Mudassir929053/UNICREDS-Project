...
<body>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-2">
                                                ...
                                                <input type="text" id="pa_duration" name="pa_duration" class="form-control" autocomplete="nope" required>
                                            ...
                                            <div class="mb-3 col-md-6">
                                                ...
                                                <select multiple="multiple" class="selectpicker" data-live-search="true" data-width="100%" tabindex="6" multiselect-max-items="20" id="pa_requirement" name="pa_requirement[]">
                                                    <optgroup label="Information Technology">
                                                        ...
                                                        <option value="Data Processing Manager">Data Processing Manager.</option>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center ">
                                                            ...
                                                            <button type="button" class="btn btn-sm btn-warning" onclick="selectReq(this)" id="<?= $pa_id ?>" data-bs-requirement="<?= $rows->pa_requirement ?>" data-bs-toggle="modal" data-bs-target="#editJob<?php echo $rows->pa_id; ?>">
                                                                    ...
                                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="mb-3 col-md-6">
                                                                                <div class="row">
                                                                                    <div class="col-md-12">
                                                                                        ...
                                                                                        <select multiple="multiple" class="selectpicker" data-live-search="true" data-width="100%" tabindex="6" id="pa_requirement<?= $pa_id ?>" name="pa_requirement[]">
                                                                                            <optgroup label="Information Technology">
                                                                                                <option value="Computer Programmer">Computer Programmer</option>
                                                                                                <option value="Information Security Analyst">Information Security Analyst</option>
                                                                                                <option value="Web Developer">Web Developer </option>
                                                                            ...
                                                                            <div class="mb-3 col-md-6">
                                                                                ...
                                                                                <input type="hidden" name="Prev_attachment_name" id="" value="<?php echo $rows->pa_attachment; ?>">
    ...
    <script>
        ...
        input.addEventListener('change', function() {
            ...
            } else if (unit === 'months' && number >= 1 && number <= 60) {
                // valid duration in months
            } else {
                // invalid duration
                alert("Invalid duration value. Please enter a number between 1 and 365 for days or 1 and 60 for months");
                input.value = "";
                return;
            }
        ...
        const selectReq = (obj) => {
            // console.log(obj)
            let id = obj.id;
            let req = obj.getAttribute('data-bs-requirement');
            // console.log(req);
            let req_arr = req.split(',');
            // console.log(req_arr)
            let selectObj = document.getElementById('pa_requirement' + id);
            // console.log(select_option)
            // select_option.value=req;
            setTimeout(function() {
                for (var i = 0; i < selectObj.options.length; i++) {
                    if (req_arr.includes(selectObj.options[i].text)) {
