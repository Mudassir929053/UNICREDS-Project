                      ...
                      <form action="" method="POST" enctype="multipart/form-data" id="addmcquiz_form" autocomplete="off">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="input-group">
                            <input name="ltq_duration" id="ltq_duration" type="number" class="form-control maskedTextField" onChange="check0(this)">
                          ...
                          <tr>
                            ...
                            <td class="text-muted px-4 py-3 align-middle border-top-0">
                              <span class="dropdown dropstart">
                                ...
                                <a class="dropdown-item" href="pages-lt-quiz-questions.php?cid=<?php echo $rows->ltq_id; ?>" title="Add Question"><i class="fas fa-question-circle dropdown-item-icon text-danger"></i>Questions</a>
