...
<?php
if (isset($_SESSION['sess_industryid'])) {
    $industryheader = $_SESSION['sess_industryid'];
    $queryindustry = $conn->query("SELECT * FROM industry 
       WHERE industry_id  = '$industryheader';");

    if (mysqli_num_rows($queryindustry) > 0) {
        $row = mysqli_fetch_object($queryindustry);
            ...
            <li class="dropdown ms-2">
                <a class="rounded-circle" href="#" role="button" id="dropdownUser" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="avatar avatar-md avatar-indicators avatar-online">
                        <?php
                        $sqlProfilePic = $conn->query("SELECT industry_logo FROM industry WHERE industry_id = '$industry_id'");

                        $checkindustryavatar = mysqli_fetch_object($sqlProfilePic);

                        if ($checkindustryavatar->industry_logo != NULL) {
                            $ProfilePic = 'images/profile_picture/' . $checkindustryavatar->industry_logo;
                        } else {
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownUser">
                    <div class="dropdown-item">
                        <div class="d-flex">
                            ...
                            <div class="ms-3 lh-1">
                                <h5 class="mb-1"><?php echo $industry_name;  ?></h5>
                                <p class="mb-0 text-muted"><?php echo $industry_email;  ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="list-unstyled">
                        ...
                        <!-- <li>
                            <a class="dropdown-item" href="#">
                                <i class="fe fe-settings me-2"></i> Change Password
                            </a>
                        </li> -->
                    </ul>
                    <div class="dropdown-divider"></div>
