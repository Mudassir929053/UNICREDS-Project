									...
									<form action="" method="POST" enctype="multipart/form-data" id="announcement">
										...
										<div class="mb-3">
											...
											<div class="input-group" style="display: inline-block;">
												...
												<div class="checkbox checkbox-info mt-1">
													<input type="checkbox" name="announcement_receiver[]" value="7" id="receive7" checked required>
								...
								<div class="card-body">
									...
									<table id="dataTableBasic1" class="table table-hover display no-wrap table-sm" style="width:100%">
										...
										<tbody class="align-middle">
											<?php
											$queryAnnouncement = $conn->query("SELECT * FROM announcement_lecturer WHERE announcement_created_by = '$lecturer_id';");
											$num = 1;
											...
											?>
													<tr>
														...
														<td class="text-center">
															...
															<a class="btn btn-danger btn-sm waves-effect waves-light" href="lecturer-function.php?delete_announcement=<?php echo $row->announcement_id; ?>" title="Delete Announcement" onClick="return deleteannouncement()">
