                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <?php if ($getmcstatus == "Processing") { ?>
                                            <li class="breadcrumb-item">
                                                <a href="#">List of Quiz Question</a>
                                            </li>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } else { ?>
                                                        <td class="text-center ">
                                                            ...
                                                            <a class="btn btn-sm btn-danger" href="lecturer-function.php?delete_quiz_question=<?php echo $rows->mcqq_id; ?>&question_answer=<?php echo $rows->mcqa_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                                        </td>
                                                    <?php } ?>
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data" id="addquestion" autocomplete="off">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="selectpicker " data-width="100%" disabled>
                                                <option value="<?php echo $row1->mcqq_type; ?>" <?php if ($row1->mcqq_type == "Multiple Choice") {
                                                                                                    echo "selected";
                                                                                                } else {
                                                                                                } ?>><?php echo $row1->mcqq_type; ?></option>
                                                <option value="<?php echo $row1->mcqq_type; ?>" <?php if ($row1->mcqq_type == "True/False") {
                                                                                                    echo "selected";
                                                                                                } else {
                                                                                                } ?>><?php echo $row1->mcqq_type; ?></option>
