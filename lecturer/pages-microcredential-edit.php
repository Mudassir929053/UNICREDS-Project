                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="mb-3 col-md-4">
                                                                        ...
                                                                        <div class="input-group" style="display: inline-block;">
                                                                            <input type="hidden" name="new_mc_level[]" value="0">
                                                                            <?php
                                            ...
                                            <div class="accordion-item shadow bg-light rounded mb-3">
                                                ...
                                                <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                                    <div class="accordion-body">
                                                        <?php echo $rows->mcld_learning_outcome; ?><br>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card mt-3 shadow" id="credittransfer">
                                                ...
                                                <div>
                                                    <div>
                                                        <button type="button" class="btn btn-warning waves-effect waves-light btn-sm shadow text-dark" data-bs-toggle="modal" data-bs-target="#editcoursecredittransfer<?php echo $rows->mccct_id; ?>">
                                                            <i class="fe fe-edit fs-5 me-1"></i>Edit</button>
                                                        <a class="btn btn-danger waves-effect waves-light btn-sm shadow text-dark" href="lecturer-function.php?delete_mccct=<?php echo $rows->mccct_id; ?>&mcid=<?php echo $rows->mc_id; ?>" title="Delete Course Credit Transfer" onclick="return deletemccct()">
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="row mt-3">
                                                                        ...
                                                                        <div class="mb-3 col-md-2">
                                                                            <label class="form-label">Course Code :</label>
                                                                            <?php
                                                                            if ($rows->mccct_course_code != NULL) { ?>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                <input id="new_mc_course_code" class="form-control" type="text" placeholder="Course Code" name="new_mc_course_code" value="N/A">
                                                                            <?php
                                                                            } ?>
                                                                        ...
                                                                        <div class="mb-3 col-md-4">
                                                                            <label class="form-label">Course Level (may select more than one) :</label>
                                                                            <div class="input-group" style="display: inline-block;">
                                                                                <input type="hidden" name="new_mc_course_level[]" value="0">
                                                                                <?php
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row mt-3">
                                                <div class="mb-3 col-md-6">
                                                    <label class="form-label">Course Title :</label>
                                                    <p class="text-dark mb-0 fw-bold"><?php echo $rows->mccct_course_title; ?></p>
                                                    <!-- <input  id="new_mc_course_title" class="form-control" type="text" name="new_mc_course_title" value="<?php echo $rows->mccct_course_title; ?>" style="text-transform:capitalize; border: none; font-weight: bold;" readonly> -->
                                                </div>
                                                ...
                                                <div class="mb-3 col-md-2">
                                                    ...
                                                    <?php
                                                    if ($rows->mccct_course_code != NULL) { ?>
                                                        <p class="text-dark mb-0 fw-bold"><?php echo $rows->mccct_course_code; ?></p>
                                                        <!-- <input id="new_mc_course_code" class="form-control" type="text" placeholder="Course Code" name="new_mc_course_code" value="<?php echo $rows->mccct_course_code; ?>" readonly> -->
                                                    <?php
                                                    } else { ?>
                                                        <p class="text-dark mb-0 fw-bold">N/A</p>
                                                        <!-- <input id="new_mc_course_code" class="form-control" type="text" placeholder="Course Code" name="new_mc_course_code" value="N/A" readonly> -->
                                                    <?php
                                                    } ?>
