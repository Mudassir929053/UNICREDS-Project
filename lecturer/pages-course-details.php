                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row align-items-center g-0 mt-1 ">
                                            <div class="col-auto">
                                                ...
                                                if ($rows->lecturer_profile_picture != NULL) {
                                                    $ProfilePic = '../lecturer/images/profile_picture/'.$rows->lecturer_profile_picture;
                                                } else {
                                            ...
                                            <div class="col lh-1">
                                                <h5 class="mb-1"><?php echo $rows->lecturer_fname; ?> <?php echo $rows->lecturer_lname; ?></h5>
                                            </div>
