                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->cq_status == 'Published') : ?>
                                                         <a href="lecturer-function.php?unpublish_cq=<?php echo $rows->cq_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->cq_status == 'Save Only') : ?>
                                                         <a href="lecturer-function.php?publish_cq=<?php echo $rows->cq_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                                                   ...
                                                   <a href="lecturer-function.php?delete_cq=<?php echo $rows->cq_id; ?>&cid=<?php echo $course_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletecq()">
                                             ...
                                             <div>
                                                ...
                                                <a class="me-1 text-inherit" href="#">
                                                   <?php if ($rows->ct_status == 'Published') : ?>
                                                      <a href="lecturer-function.php?unpublish_ct=<?php echo $rows->ct_id; ?>" title="Unpublish Test" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishtest()">
                                                         <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                   <?php if ($rows->ct_status == 'Save Only') : ?>
                                                      <a href="lecturer-function.php?publish_ct=<?php echo $rows->ct_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Test" onclick="return publishtest()">
                                                         <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                </a>
                                                ...
                                                <a href="lecturer-function.php?delete_ct=<?php echo $rows->ct_id; ?>&cid=<?php echo $course_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletect()">
                                                   <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->ctu_status == 'Published') : ?>
                                                         <a href="lecturer-function.php?unpublish_ctu=<?php echo $rows->ctu_id; ?>" title="Unpublish Tutorial" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishtutorial()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->ctu_status == 'Save Only') : ?>
                                                         <a href="lecturer-function.php?publish_ctu=<?php echo $rows->ctu_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Tutorial" onclick="return publishtutorial()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" accept="image/jpeg, image/png, video/mp4, video/webm" class="form-control custom-file-input" name="ctu_attachment" id="ctu_attachment<?php echo $rows->ctu_id; ?>">
                                                   ...
                                                   <a href="lecturer-function.php?delete_ctu=<?php echo $rows->ctu_id; ?>&cid=<?php echo $course_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletectu()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmctutorial_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" type="file" name="ctu_attachment" accept="image/jpeg, image/png, video/mp4, video/webm" id="ctu_attachment">
