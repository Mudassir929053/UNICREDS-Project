                                                   ...
                                                   <?php } else { ?>
                                                      ...
                                                      <a class="me-1 text-inherit" href="#">
                                                         <?php if ($rows->mcq_status == 'Published') : ?>
                                                            <a href="lecturer-function.php?unpublish_mcq=<?php echo $rows->mcq_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                                               <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                         <?php endif ?>
                                                         <?php if ($rows->mcq_status == 'Save Only') : ?>
                                                            <a href="lecturer-function.php?publish_mcq=<?php echo $rows->mcq_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                                                      ...
                                                      <a href="lecturer-function.php?delete_mcq=<?php echo $rows->mcq_id; ?>&mc_id=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcq()">
                                                                  ...
                                                                  <?php if ($getmcstatus == "Processing") { ?>
                                                                     <a href="pages-mc-assessment-quiz.php?mcid=<?php echo $mcid; ?>&mcq_id=<?php echo $rows->mcq_id ?>" data-bs-toggle="tooltip" data-placement="top" title="Add Question">
                                                                        <span class="badge rounded-pill bg-primary">
                                                                           <i class="fe fe-eye fs-4 me-1" style="vertical-align: middle;"></i>
                                                                           View Question
                                                                        </span>
                                                                     </a>
                                                                  <?php } else { ?>
                                                                     <a href="pages-mc-assessment-quiz.php?mcid=<?php echo $mcid; ?>&mcq_id=<?php echo $rows->mcq_id ?>" data-bs-toggle="tooltip" data-placement="top" title="Add Question">
                                                                        <span class="badge rounded-pill bg-info">
                                                                           <i class="fe fe-plus-circle fs-4 me-1" style="vertical-align: middle;"></i>
                                                                           Customize Question
                                                                        </span>
                                                                     </a>
                                                                  <?php } ?>
                                                ...
                                                <?php } else { ?>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mct_status == 'Published') : ?>
                                                         <a href="lecturer-function.php?unpublish_mct=<?php echo $rows->mct_id; ?>" title="Unpublish Test" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishtest()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mct_status == 'Save Only') : ?>
                                                         <a href="lecturer-function.php?publish_mct=<?php echo $rows->mct_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Test" onclick="return publishtest()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                   ...
                                                   <a href="lecturer-function.php?delete_mct=<?php echo $rows->mct_id; ?>&mc_id=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemct()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                                   ...
                                                   <table class="table table-bordered text-nowrap mb-0" style="width:100%">
                                                      ...
                                                      <tbody class="align-middle">
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td>
                                                               <?php if ($getmcstatus == "Processing") { ?>
                                                                  <a href="pages-mc-assessment-test.php?mcid=<?php echo $mcid; ?>&mct_id=<?php echo $rows->mct_id ?>" data-bs-toggle="tooltip" data-placement="top" title="Add Question">
                                                                     <span class="badge rounded-pill bg-primary">
                                                                        <i class="fe fe-eye fs-4 me-1" style="vertical-align: middle;"></i>
                                                                        View Question
                                                                     </span>
                                                   ...
                                                   <?php } else { ?>
                                                      ...
                                                      <a class="me-1 text-inherit" href="#">
                                                         <?php if ($rows->mctu_status == 'Published') : ?>
                                                            <a href="lecturer-function.php?unpublish_mctu=<?php echo $rows->mctu_id; ?>" title="Unpublish Tutorial" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishtutorial()">
                                                               <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                         <?php endif ?>
                                                         <?php if ($rows->mctu_status == 'Save Only') : ?>
                                                            <a href="lecturer-function.php?publish_mctu=<?php echo $rows->mctu_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Tutorial" onclick="return publishtutorial()">
                                                               <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                         <?php endif ?>
                                                      </a>
                                                      ...
                                                      <a href="lecturer-function.php?delete_mctu=<?php echo $rows->mctu_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemctu()">
                                                         <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmctutorial_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" type="file" accept="image/jpeg, image/png, video/mp4, video/webm" name="mctu_attachment" id="mctu_attachment">
