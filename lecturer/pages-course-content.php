                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->cn_status == 'Published') : ?>
                                                         <a href="lecturer-function.php?unpublish_cn=<?php echo $rows->cn_id; ?>" title="Unpublish Note" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishnote()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->cn_status == 'Save Only') : ?>
                                                         <a href="lecturer-function.php?publish_cn=<?php echo $rows->cn_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Note" onclick="return publishnote()">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" accept="image/jpeg, image/png" class="form-control custom-file-input" name="cn_attachment" id="cn_attachment<?php echo $rows->cn_id; ?>">
                                                   ...
                                                   <a href="lecturer-function.php?delete_cn=<?php echo $rows->cn_id; ?>&cid=<?php echo $course_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletecn()">
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addcnote_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" type="file" accept="image/jpeg, image/png" name="cn_attachment" id="cn_attachment">
                                             ...
                                             <div>
                                                ...
                                                <a class="me-1 text-inherit" href="#">
                                                   <?php if ($rows->cv_status == 'Published') : ?>
                                                      <a href="lecturer-function.php?unpublish_cv=<?php echo $rows->cv_id; ?>" title="Unpublish Video" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishvideo()">
                                                         <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                   <?php if ($rows->cv_status == 'Save Only') : ?>
                                                      <a href="lecturer-function.php?publish_cv=<?php echo $rows->cv_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Video" onclick="return publishvideo()">
                                                         <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                </a>
                                                ...
                                                <a href="lecturer-function.php?delete_cv=<?php echo $rows->cv_id; ?>&cid=<?php echo $course_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletecv()">
                                                   <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->cs_status == 'Published') : ?>
                                                         <a href="lecturer-function.php?unpublish_cs=<?php echo $rows->cs_id; ?>" title="Unpublish Slide" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishslide()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->cs_status == 'Save Only') : ?>
                                                         <a href="lecturer-function.php?publish_cs=<?php echo $rows->cs_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Slide" onclick="return publishslide()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                            ...
                                                            <div class="modal-body">
                                                               <form action="" method="POST" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" class="form-control custom-file-input" name="cs_attachment" id="cs_attachment<?php echo $rows->cs_id; ?>">
                                                   ...
                                                   <a href="lecturer-function.php?delete_cs=<?php echo $rows->cs_id; ?>&cid=<?php echo $course_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletecs()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addcslide_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" type="file" name="cs_attachment" id="cs_attachment">
