...
$checkinstitutionrow = $conn->query("SELECT * from institution where institution_id  = '1'");
$rowReadinstitution = $checkinstitutionrow->fetch_object();
$get_institutionID = $rowReadinstitution->institution_id;
?>
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-12">
              <div class="card shadow">
                ...
                <!-- table  -->
                <div class="card-body">
                  <table id="dataTableBasic" class="table table-hover table-sm display no-wrap" style="width:100%">
                    ...
                    <tbody class="align-middle">
                      ...
                      $querymc = $conn->query("SELECT * FROM microcredential
                                               ...
                                               WHERE mc_created_by = '$get_userID' AND mc_owner = '1' 
                            ...
                            <td class="text-center">
                              ...
                              <?php if ($rows->mc_status == 'Draft') {
                                ...
                                if ($totallearningvideo >= 1 && $totallearningactivity >= 1 && $totalassessment >= 1) { ?>
                                  <a class="btn btn-sm btn-success shadow" href="admin-function.php?publish_mc=<?php echo $rows->mc_id; ?>" title="Publish Micro-Credential" onclick="return publishmc()">Publish</a>
                                <?php } else { ?>
                                ...
                                <?php } ?>
                              <?php } else { ?>
                                <a class="btn btn-sm btn-warning shadow" href="admin-function.php?unpublish_mc=<?php echo $rows->mc_id; ?>" title="Unpublish Micro-Credential" onclick="return unpublishmc()">Unpublish</a>
                              <?php  } ?>
