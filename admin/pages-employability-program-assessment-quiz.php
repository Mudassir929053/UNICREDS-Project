            ...
            <div class="mb-3 mb-md-0">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="pages-employability-program-content-assessment.php?cid=<?php echo $ep_id; ?>">Employabiltiy Program Assessment</a>
                        </li>
                        <li class="breadcrumb-item">
            ...
            <div class="card-body">
                ...
                <table id="dataTableBasic1" class="table table-sm table-bordered table-hover display no-wrap" style="width:100%">
                    ...
                    <tbody class="align-middle">
                        ...
                        $queryquizquestion = $conn->query("SELECT * from employability_program_quiz_question 
                                                            LEFT JOIN employability_program_quiz_answer 
                                                            ON employability_program_quiz_question.epqq_id = employability_program_quiz_answer.epqa_epq_id 
                                                            WHERE employability_program_quiz_question.epq_ep_id =  $epq_id;");
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center ">
                                        ...
                                        <a class="btn btn-sm btn-danger" href="admin-function.php?delete_course_quiz_question=<?php echo $rows->epqq_id; ?>&cquestion_answer=<?php echo $rows->epqa_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                                    </td>
                                </tr>
                        <?php
                            }
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success btn-sm" name="add_ep_quiz_question">Submit</button>
            </div>
        </div>
    </div>
    </form>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" id="addquestion" autocomplete="off">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="selectpicker " data-width="100%" disabled>
                                <option value="<?php echo $row1->epqq_type; ?>" <?php if($row1 -> epqq_type == "Multiple Choice"){echo "selected";} else {}?>><?php echo $row1->epqq_type; ?></option>
                                <option value="<?php echo $row1->epqq_type; ?>" <?php if($row1 -> epqq_type == "True/False"){echo "selected";} else {}?>><?php echo $row1->epqq_type; ?></option>
