            ...
            <div class="row">
               <div class="col-lg-12 col-md-12 col-12">
                  ...
                  <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                     ...
                     <!-- <div>
                        <a class="btn btn-primary waves-effect waves-light btn-sm shadow" href="pages-mcreq-assessment.php?mcid=<?php echo $mcid; ?>">
                           <i class="mdi mdi-note-multiple me-1"></i> Manage Assessment </a>

                        <a class="btn btn-sm btn-secondary waves-effect waves-light shadow" href="pages-mcreq-list.php" ><i class="mdi mdi-keyboard-backspace"></i> Back </a>
                     </div> -->
                     <div>
                                          ...
                                          <div class="list-group-item rounded m-1">
                                                   ...
                                                   <?php } else { ?>
                                                      ...
                                                      <a class="me-1 text-inherit" href="#">
                                                         <?php if ($rows->mcn_status == 'Published') : ?>
                                                            <a href="admin-function.php?unpublish_mcn=<?php echo $rows->mcn_id; ?>" title="Unpublish Note" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishnote()">
                                                               <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                         <?php endif ?>
                                                         <?php if ($rows->mcn_status == 'Save Only') : ?>
                                                            <a href="admin-function.php?publish_mcn=<?php echo $rows->mcn_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Note" onclick="return publishnote()">
                                                                     ...
                                                                     <div class="mb-3 col-md-12">
                                                                        ...
                                                                        <div class="custom-file">
                                                                           <div class="input-group mb-1">
                                                                              <input type="file" onChange="readURL(this);" class="form-control custom-file-input" name="mcn_attachment" id="mnn_attachment<?php echo $rows->mcn_id; ?>">
                                                      ...
                                                      <a href="admin-function.php?delete_mcn=<?php echo $rows->mcn_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcn()">
                                             ...
                                             <div class="collapse" id="notedetail<?php echo $rows->mcn_id ?>" data-bs-parent="#notelist">
                                                <div class="card-body">
                                                   ...
                                                   ?>
                                                      <a class="btn btn-outline-primary waves-effect waves-light btn-sm" href="../assets/attachment/microcredential/mcnote/<?php echo $rows->mcn_attachment; ?>" target="_blank" data-bs-toggle="tooltip" data-placement="top" title="View Attachment"> 
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmcnote_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" type="file" name="mcn_attachment" id="mcn_attachment">
                                                ...
                                                <?php } else { ?>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mcv_status == 'Published') : ?>
                                                         <a href="admin-function.php?unpublish_mcv=<?php echo $rows->mcv_id; ?>" title="Unpublish Video" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishvideo()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mcv_status == 'Save Only') : ?>
                                                         <a href="admin-function.php?publish_mcv=<?php echo $rows->mcv_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Video" onclick="return publishvideo()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                            ...
                                                            <div class="modal-body">
                                                               <form action="" method="POST" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" class="form-control custom-file-input" name="mcv_attachment" accept="video/mp4, video/webm" id="mcv_attachment<?php echo $rows->mcv_id; ?>">
                                                   ...
                                                   <a href="admin-function.php?delete_mcv=<?php echo $rows->mcv_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcv()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                          ...
                                          <div class="list-group-item rounded m-1">
                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->mcs_status == 'Published') : ?>
                                                         <a href="admin-function.php?unpublish_mcs=<?php echo $rows->mcs_id; ?>" title="Unpublish Slide" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishslide()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->mcs_status == 'Save Only') : ?>
                                                         <a href="admin-function.php?publish_mcs=<?php echo $rows->mcs_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Slide" onclick="return publishslide()">
                                                            <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                   </a>
                                                            ...
                                                            <div class="modal-body">
                                                               <form action="" method="POST" enctype="multipart/form-data">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <div class="custom-file">
                                                                        <div class="input-group mb-1">
                                                                           <input type="file" onChange="readURL(this);" class="form-control custom-file-input" accept="application/vnd.ms-powerpoint, application/vnd.openxmlformats-officedocument.presentationml.presentation" name="mcs_attachment" id="mcs_attachment<?php echo $rows->mcs_id; ?>">
                                                   ...
                                                   <a href="admin-function.php?delete_mcs=<?php echo $rows->mcs_id; ?>&mcid=<?php echo $mcid; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletemcs()">
                                                      <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                             ...
                                             <div class="collapse" id="slidedetail<?php echo $rows->mcs_id ?>" data-bs-parent="#slidelist">
                                                <div class="card-body">
                                                   ...
                                                   ?>
                                                      <a class="btn btn-outline-primary waves-effect waves-light btn-sm" href="../assets/attachment/microcredential/mcslide/<?php echo $rows->mcs_attachment; ?>" target="_blank" data-bs-toggle="tooltip" data-placement="top" title="View Attachment"> 
                                                      <span class="hidden-xs-down"><i class="mdi mdi-folder-multiple-image fs-4" aria-hidden="true"></i> Attachment </span></a>
                                                   <?php
                                                   } else {
                                                   ?>
                                 ...
                                 <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="addmcslide_form" autocomplete="off">
                                       ...
                                       <div class="mb-3 col-md-12">
                                          <label class="form-label" for="textInput">Attachment :</label>
                                          <div class="input-group mb-1">
                                             <input class="dropify form-control" type="file" name="mcs_attachment" accept="application/vnd.ms-powerpoint, application/vnd.openxmlformats-officedocument.presentationml.presentation" id="mcs_attachment">
