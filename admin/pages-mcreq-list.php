                                    ...
                                    <div>
                                        ...
                                        <ul class="nav nav-lb-tab" id="tab" role="tablist">
                                            ...
                                            <?php $querymcdraft = $conn->query("SELECT * FROM microcredential 
                                                                                 ...
                                                                                 WHERE mc_status = 'Draft' AND mc_created_by = '$get_userID' AND mc_owner != '1'
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link <?php if ($tab_type == "Draft") {
                                                    ...
                                                    <?php if (mysqli_num_rows($querymcdraft) > 0) { ?>
                                                        <span class="badge rounded-pill bg-secondary text-white shadow position-absolute mt-n1 ms-1"><?php echo mysqli_num_rows($querymcdraft); ?></span>
                                                    <?php } else {
                                                    } ?>
                                                </a>
                                            </li>
                                            ...
                                            <?php $querymcprocess = $conn->query("SELECT * FROM microcredential
                                                                                 ...
                                                                                 LEFT JOIN institution ON mc_owner = institution.institution_id
                                                                                 LEFT JOIN university ON institution.institution_university_id = university.university_id                                    
                                                                                 WHERE mc_status = 'Processing' AND mc_created_by = '$get_userID' AND mc_owner != '1'
                                                                                 ORDER BY mc_created_date DESC ;");  ?>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link <?php if ($tab_type == "Processing") {
                                                    ...
                                                    <?php if (mysqli_num_rows($querymcprocess) > 0) { ?>
                                                        <span class="badge rounded-pill bg-warning text-white shadow position-absolute mt-n1 ms-1"><?php echo mysqli_num_rows($querymcprocess); ?></span>
                                                    <?php } else {
                                                    } ?>
                                                </a>
                                            </li>
                                            ...
                                            <?php $querymcreject = $conn->query("SELECT * FROM microcredential
                                                                                 ...
                                                                                 LEFT JOIN institution ON mc_owner = institution.institution_id
                                                                                 LEFT JOIN university ON institution.institution_university_id = university.university_id                                    
                                                                                 WHERE mc_status = 'Rejected' AND mc_created_by = '$get_userID' AND mc_owner != '1'
                                                                                 ORDER BY mc_created_date DESC ;");  ?>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link <?php if ($tab_type == "Rejected") {
                                                    ...
                                                    <?php if (mysqli_num_rows($querymcreject) > 0) { ?>
                                                        <span class="badge rounded-pill bg-danger text-white shadow position-absolute mt-n1 ms-1"><?php echo mysqli_num_rows($querymcreject); ?></span>
                                                    <?php } else {
                                                    } ?>
                                                </a>
                                            </li>
                                            ...
                                            <?php $querymcapprove = $conn->query("SELECT * FROM microcredential
                                                                                 ...
                                                                                 LEFT JOIN institution ON mc_owner = institution.institution_id
                                                                                 LEFT JOIN university ON institution.institution_university_id = university.university_id                                    
                                                                                 WHERE mc_status = 'Approved' AND mc_created_by = '$get_userID' AND mc_owner != '1'
                                                                                 ORDER BY mc_created_date DESC ;");  ?>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link <?php if ($tab_type == "Approved") {
                                                    ...
                                                    <?php if (mysqli_num_rows($querymcapprove) > 0) { ?>
                                                        <span class="badge rounded-pill bg-success text-white shadow position-absolute mt-n1 ms-1"><?php echo mysqli_num_rows($querymcapprove); ?></span>
                                                    <?php } else {
                                                    } ?>
                                                </a>
                                            </li>
                                            ...
                                            <?php $querymcpublish = $conn->query("SELECT * FROM microcredential 
                                                                                 ...
                                                                                 LEFT JOIN institution ON mc_owner = institution.institution_id
                                                                                 LEFT JOIN university ON institution.institution_university_id = university.university_id                                    
                                                                                 WHERE mc_status = 'Published' AND mc_created_by = '$get_userID' AND mc_owner != '1'
                                                                                 ORDER BY mc_created_date DESC;");  ?>
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link <?php if ($tab_type == "Published") {
                                                    ...
                                                    <?php if (mysqli_num_rows($querymcpublish) > 0) { ?>
                                                        <span class="badge rounded-pill bg-primary text-white shadow position-absolute mt-n1 ms-1"><?php echo mysqli_num_rows($querymcpublish); ?></span>
                                                    <?php } else {
                                                    } ?>
                                                </a>
                                            </li>
                                                ...
                                                <table id="dataTableBasic1" class="table table-hover table-sm display no-wrap shadow " style="width:100%">
                                                    <thead class="bg-gradient bg-light-secondary text-dark">
                                                        <tr class="text-center">
                                                            ...
                                                            <th scope="col" class="border-0" width="400px">Micro-Credential Description</th>
                                                                        ...
                                                                        <a class="text-inherit">
                                                                            <div class="d-lg-flex align-items-center">
                                                                                ...
                                                                                <div class="ms-lg-3 mt-2 mt-lg-0">
                                                                                    <a data-bs-toggle="tooltip" title="View Details" href="pages-mcreq-details.php?mcid=<?php echo $rows->mc_id; ?>">
                                                                        ...
                                                                        <?php if ($rows->mc_status == 'Draft') {
                                                                            ...
                                                                            if ($totallearningvideo >= 1 && $totallearningactivity >= 1 && $totalassessment >= 1) { ?>
                                                                                <form action="" method="POST" enctype="multipart/form-data">
                                                                                    ...
                                                                                    <button type="submit" class="btn btn-sm btn-success shadow " name="request_mc" onclick="return requestmc()">
                                                                                        Request</button>
                                                                                </form>
                                                                            <?php } else { ?>
                                                                                <span class="d-inline-block" tabindex="0" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-html="true" title="<p class='text-start'>A complete module contains at least the followings :</p>
                                                                                    ...
                                                                                    <button class="btn btn-sm text-white btn-secondary shadow" style="pointer-events: none;" type="button" disabled>
                                                                                        Request Disabled
                                                                                    </button>
                                                                                </span>
                                                                            <?php } ?>
                                                                    ...
                                                                    <td class="text-muted px-4 py-3 align-middle border-top-0 text-center">
                                                                        <span class="dropdown dropstart">
                                                                            ...
                                                                            <span class="dropdown-menu" aria-labelledby="courseDropdown"><span class="dropdown-header">Action</span>
                                                                                <a class="dropdown-item" href="pages-mcreq-details.php?mcid=<?php echo $rows->mc_id; ?>"><i class="fe fe-eye dropdown-item-icon text-info"></i>View Details</a>
                                                                                <a class="dropdown-item" href="pages-mcreq-content.php?mcid=<?php echo $rows->mc_id; ?>"><i class="fe fe-folder-plus dropdown-item-icon text-primary"></i></i>Manage Content</a>
                                                                                <a class="dropdown-item" href="pages-mcreq-edit.php?mcid=<?php echo $rows->mc_id; ?>"><i class="fe fe-edit dropdown-item-icon text-warning"></i>Edit</a>
                                                                                <a class="dropdown-item" href="admin-function.php?delete_mc=<?php echo $rows->mc_id; ?>" title="Delete Micro-Credential" onclick="return deletemc()"><i class="fe fe-trash dropdown-item-icon text-danger"></i>Delete</a>
                                                                            </span>
                                                                        </span>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <table id="dataTableBasic3" class="table table-hover table-sm display no-wrap shadow" style="width:100%">
                                                    <thead class="bg-gradient bg-light-danger text-dark">
                                                        <tr class="text-center">
                                                            <th scope="col" class="border-0" width="10px">No.</th>
                                                            <th scope="col" class="border-0" width="250px">Micro-Credential</th>
                                                            <th scope="col" class="border-0" width="200px">Micro-Credential Description</th>
                                                            <th scope="col" class="border-0">Fee</th>
                                                            <th scope="col" class="border-0">Status</th>
                                                    ...
                                                    <tbody class="align-middle">
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <a class="btn btn-sm btn-outline-success" href="admin-function.php?publish_mc=<?php echo $rows->mc_id; ?>" title="Publish Course" onclick="return publishcourse()">Publish</a>
                                                                    </td>
