                ...
                <div class="container">
                    <div class="row">
                        <div class="d-lg-flex align-items-center justify-content-between">
                            ...
                            <div>
                                <a href="pages-mcreq-list.php" class="btn btn-sm btn-info shadow"><i class="mdi mdi-keyboard-backspace me-2"></i>Back to menu</a>
                            </div>
                        </div>
                    </div>
                </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="mb-3 col-md-6">
                                                            ...
                                                            <input style="text-transform:capitalize" id="mc_title" class="form-control" type="text" placeholder="Micro-Credential Title" name="mc_title" autocomplete="off">
                                                        </div>
                                                        ...
                                                        <div class="mb-3 col-md-4">
                                                            ...
                                                            <div class="input-group" style="display: inline-block;">
                                                                <!-- <input type="hidden" name="mc_level[]" > -->
                                                                ...
                                                                <div class="checkbox checkbox-info">
                                                                    <input type="checkbox" name="mc_level[]" value="3" id="mc_cpd">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="mc_desc" id="editormcdesc"></textarea>
                                                        <small>A summary of your micro-credential.</small>
                                                        <script>
                                                            ClassicEditor
                                                                .create(document.querySelector('#editormcdesc'), {
                                                    ...
                                                    <div class="mb-2">
                                                        <label class="form-label">Does the course lead to credit transfer to existing academic programme <?php if ($row_uni->university_name != 'Unicreds') {
                                                                                                                                                                echo 'in <b class="fs-5 text-warning">' . $row_uni->university_name;
                                                                                                                                                            } else {
                                                                                                                                                            } ?></b> ? :</label>
                                            ...
                                            <div class="card mb-3 shadow">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" name="mc_il" id="mcil" placeholder="Example : Undergraduate students/Postgraduate students or worker etc.."></textarea>
                                                        <small>A summary of your micro-credential.</small>
                                                        <script>
                                                            ClassicEditor
                                                                .create(document.querySelector('#mcil'), {
