...
<?php $industry_id = $_SESSION['sess_adminid'];
$pt_id = $_GET['pt_id'];
?>
                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                    ...
                                    <?php $queryquizquestion = $conn->query("SELECT * from  psychometric_test_section where pts_pt_id = $pt_id  ORDER BY pts_created_date; ");
                                            ...
                                            <ul class="m-d expand-list">
                                                <li data-md-content="10000" class="border border-info shadow-lg p-3  rounded rounded-0 m-2 py-3 pb-3 px-5 bg-gradiant" style="background-color:hsl(35.7, 100%, 57.5%)">
                                                    ...
                                                    <span class="sectiond">
                                                        ...
                                                        <a href="admin-function.php?delete_pts=<?php echo  $rows['pts_id']; ?>" class=" text-danger" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletesection()">
                                                                                                ...
                                                                                                <div class="col-md-12 text-white bg-light">
                                                                                                    ...
                                                                                                    <div class="d-flex flex-row-reverse bd-highlight">
                                                                                                        <div class="p-2 bd-highlight text-black">
                                                                                                            <a class="btn btn-sm btn-danger" href="admin-function.php?delete_psychometric_test_question=<?php echo $rows1['ptq_id']; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                                                                        </div>
                                                                                                        <div class="p-2 bd-highlight text-black">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="" method="POST" enctype="multipart/form-data" id="addTF" autocomplete="off">
                                                                    ...
                                                                    <div class="mb-3 col-12 float-start">
                                                                        <label class="form-label">Question :</label>
                                                                        <input type="hidden" class="form-control" name="slno[]" value="1" readonly>
