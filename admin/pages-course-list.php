                            ...
                            <td class="text-center">
                              ...
                              <?php if ($rows->course_status == 'Draft') {
                                ...
                                if ($totallearningvideo >= 1 && $totallearningactivity >= 1 && $totalassessment >= 1) { ?>
                                  <a class="btn btn-sm btn-success shadow" href="admin-function.php?publish_course=<?php echo $rows->course_id; ?>" title="Publish Course" onclick="return publishcourse()">Publish</a>
                                <?php } else { ?>
                                ...
                                <?php } ?>
                              <?php } else { ?>
                                <a class="btn btn-sm btn-warning shadow" href="admin-function.php?unpublish_course=<?php echo $rows->course_id; ?>" title="Unpublish Course" onclick="return unpublishcourse()">Unpublish</a>
                              <?php  } ?>
                            ...
                            <td class="text-muted px-4 py-3 align-middle border-top-0">
                              <span class="dropdown dropstart">
                                ...
                                <span class="dropdown-menu" aria-labelledby="courseDropdown"><span class="dropdown-header">Action</span>
                                  ...
                                  <a class="dropdown-item" href="pages-course-content.php?cid=<?php echo $rows->course_id; ?>"><i class="fe fe-folder-plus dropdown-item-icon text-primary"></i>Manage Content</a>
                                  ...
                                  <a class="dropdown-item" href="admin-function.php?delete_course=<?php echo $rows->course_id; ?>" title="Delete Course" onclick="return deletecourse()"><i class="fe fe-trash dropdown-item-icon text-danger"></i>Delete</a>
                                </span>
                              </span>
                            </td>
                          </tr>
