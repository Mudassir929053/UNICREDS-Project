                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td class="text-center ">
                                                                    ...
                                                                    <a class="px-3 fa-lg text-danger" href="admin-function.php?delete_language_test_question=<?php echo $rows->ltq_id; ?>&delete_language_test_answer=<?php echo $rows->lta_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true" data-bs-toggle="tooltip" data-placement="top" title="Delete"></i> </a>
                                                                </td>
                                                            </tr>
                                                            <!-- Modal for More -->
                            ...
                            <div class="tab-pane <?php if ($stq_type == "fileupload") {
                                ...
                                <div class="bg-light-info rounded p-2 mb-3 shadow">
                                    <div class="card-body bg-white">
                                        ...
                                        $queryquizquestion = $conn->query("SELECT * FROM language_test_answer AS LTA 
                                        LEFT JOIN language_test_question AS LTQ ON LTA.lta_id_ltq_id=LTQ.ltq_id 
                                        LEFT JOIN language_test_comp_pasage AS LTP ON LTP.ltcp_id=LTQ.ltq_id_ltc_id
                                        WHERE LTP.test_id='$lid' 
                                        AND LTQ.ltq_id_ltc_id IS NOT NULL GROUP BY LTP.ltcp_id; ");
...
">
                                                                <span class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseThree<?php echo $rows->ltcp_id; ?>" aria-expanded="false" aria-controls="flush-collapseThree">
                                                                    ...
                                                                    <span style="position:sticky;left:1630px; ">
                                                                        <a href="#" class="me-1 text-inherit" data-bs-toggle="modal" data-bs-target="#editpassage<?php echo $rows->ltcp_id; ?>">
                                                                            <i class="bi bi-pencil-square text-info fs-3" data-bs-toggle="tooltip" data-placement="top" title="Edit"></i></a>
                                                                        <a href="admin-function.php?delete_language_test_question_for_passage=<?php echo $rows->ltq_id; ?>&delete_language_test_answer_for_passage=<?php echo $rows->lta_id; ?> &delete_language_test_passage=<?php echo $rows->ltcp_id; ?>" class="me-1 text-inherit" onclick="return deletequestion1()" style="margin-left: 10px;">
                                                                            <i class="bi bi-trash-fill text-danger fs-3" data-bs-toggle="tooltip" data-placement="top" aria-hidden="true" title="Delete"></i></a>
                                                                        <a class="me-1 text-inherit" href="languagetest-questions-preview.php?cid=<?php echo $lid ?>&pid=<?php echo $rows->ltcp_id; ?>" style="margin-left: 10px;">
                                                                            <i class="bi bi-eye-fill fs-3" aria-hidden="true" data-bs-toggle="tooltip" data-placement="top" title="Preview"></i></a>
                                                                    </span>
                                                                </span>
                                                                                    ...
                                                                                    ?>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td class="text-center">
                                                                                                    ...
                                                                                                    <a class="btn btn-sm btn-danger" href="admin-function.php?delete_language_test_question=<?php echo $rows->ltq_id; ?>&delete_language_test_answer=<?php echo $rows->lta_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash me-1" aria-hidden="true"></i>Delete</a>
                                                                                                </td>
                                                                                            </tr>
