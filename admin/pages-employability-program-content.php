               ...
               <div class="col-lg-12 col-md-12 col-12">
                  ...
                  <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                     <div class="mb-3 mb-md-0">
                        <h1 class="mb-1 h2 fw-bold">Employability Program Content</h1>
                        <!-- Breadcrumb -->
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              <li class="breadcrumb-item">
                                 <a href="pages-course-list.php">Employability Program</a>
                              </li>
                              <li class="breadcrumb-item">
                                 <a href="#">Employability Program Content</a>
                              </li>
                                                ...
                                                <div>
                                                   ...
                                                   <a class="me-1 text-inherit" href="#">
                                                      <?php if ($rows->epn_status == 'Published') : ?>
                                                         <a href="admin-function.php?unpublish_cn=<?php echo $rows->epn_id; ?>" title="Unpublish Note" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishnote()">
                                                            <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                      <?php endif ?>
                                                      <?php if ($rows->epn_status == 'Save Only') : ?>
                                                         <a href="admin-function.php?publish_cn=<?php echo $rows->epn_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Note" onclick="return publishnote()">
                                                      ...
                                                      <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                                                         <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                               <form action="" method="POST" enctype="multipart/form-data">
                                                                  <div class="mb-3">
                                                                     ...
                                                                     $ep_id = $_GET['cid'];
                                                                     ?>
                                                                     <input type="hidden" name="cid" value="<?php echo $ep_id; ?>">
                                                                  ...
                                                                  <div class="mb-3 col-md-12">
                                                                     ...
                                                                     <?php if ($rows->epn_attachment != NULL) { ?>
                                                                        <p>Current File : <a href="../assets/attachment/employability_program/epnotes/<?php echo $rows->epn_attachment; ?>" target="_blank">
                                                            ...
                                                            <div class="modal-footer">
                                                               ...
                                                               <button type="submit" class="btn btn-success btn-sm" name="edit_epn">Save</button>
                                                            </div>
                                                            </form>
                                                         </div>
                                                      </div>
                                                   ...
                                                   <a href="admin-function.php?delete_cn=<?php echo $rows->epn_id; ?>&cid=<?php echo $ep_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletecn()">
                        ...
                        <div class="modal fade" id="addcoursenote" tabindex="-1" role="dialog" aria-labelledby="cnotemodal" aria-hidden="true">
                           ...
                           <div class="modal-dialog modal-dialog-centered modal-lg">
                              <div class="modal-content">
                                 ...
                                 <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-success btn-sm" name="add_ep_note">Save</button>
                                 </div>
                              </div>
                           </div>
                           </form>
                     ...
                     <div class="tab-pane <?php if ($content_type == "Video") {
                        ...
                        <div class="bg-light-info rounded p-2 mb-3 shadow">
                           ...
                           $querycv = $conn->query("SELECT * FROM employabilty_program_video
                                                     ...
                                                     WHERE epv_ep_id = '$ep_id' ORDER BY  epv_id DESC");
                                 ...
                                 <div class="list-group list-group-flush border-top-0" id="vidlist">
                                    <div> 
                                       <div class="list-group-item rounded m-1">
                                          <div class="d-flex align-items-center justify-content-between">
                                             <h5 class="mb-0">
                                                <a href="#notedetail<?php echo $rows->epn_id ?>" class="text-inherit" aria-expanded="true" data-bs-toggle="collapse" data-bs-target="#viddetail<?php echo $rows->epv_id ?>" aria-controls="viddetail">
                                                   <i class="fe fe-menu me-1 text-muted align-middle"></i>
                                             ...
                                             <div>
                                                ...
                                                <a class="me-1 text-inherit" href="#">
                                                   <?php if ($rows->epv_status == 'Published') : ?>
                                                      <a href="admin-function.php?unpublish_cv=<?php echo $rows->epv_id; ?>" title="Unpublish Video" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishvideo()">
                                                         <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                   <?php if ($rows->epv_status == 'Save Only') : ?>
                                                      <a href="admin-function.php?publish_cv=<?php echo $rows->epv_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Video" onclick="return publishvideo()">
                                                         <i class="fas fa-toggle-off dropdown-item-icon text-dark" style="vertical-align: middle;"></i></a>
                                                   <?php endif ?>
                                                </a>
                                                ...
                                                <div class="modal fade" id="modaleditvideo<?php echo $rows->epv_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editmcv" aria-hidden="true">
                                                   <div class="modal-dialog modal-dialog-centered modal-lg modal-dialog-scrollable" role="document">
                                                      <div class="modal-content">
                                                         ...
                                                         <div class="modal-body">
                                                            <form action="" method="POST" enctype="multipart/form-data">
                                                               ...
                                                               <div class="mb-3 col-md-12">
                                                                  ...
                                                                  <div class="custom-file">
                                                                     <div class="input-group mb-1">
                                                                        <input type="file" onChange="readURL(this);" accept="video/mp4, video/webm" class="form-control custom-file-input" name="cv_attachment" id="cv_attachment<?php echo $rows->epv_id; ?>">
                                                                  ...
                                                                  <?php if ($rows->epv_attachment != NULL) { ?>
                                                                     ...
                                                                     <p>Current File : <a href="../assets/attachment/course/coursevideo/<?php echo $rows->epv_attachment; ?>" target="_blank">
                                                         ...
                                                         <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="modal">Close</button>
                                                            <button type="submit" class="btn btn-success btn-sm" name="edit_ev">Save</button>
                                                         </div>
                                                         </form>
                                                      </div>
                                                   </div>
                                                ...
                                                <a href="admin-function.php?delete_cv=<?php echo $rows->epv_id; ?>" class="me-1 text-inherit" data-bs-toggle="tooltip" data-placement="top" title="Delete" onclick="return deletecv()">
                                                   <i class="fe fe-trash-2 fs-3" style="vertical-align: middle;"></i></a>
                                          ...
                                          <div id="viddetail<?php echo $rows->epv_id ?>" class="collapse" data-bs-parent="#vidlist">
                                             <div class="card-body bg-info rounded p-3 mt-2">
                                                <!-- <a class="popup-youtube d-flex justify-content-between align-items-center text-inherit text-decoration-none" href="../assets/attachment/course/coursevideo/<?php #echo $rows->epv_attachment; 
                                                                                                                                                                                                                  ?>"> -->
                                                <a class="popup-youtube d-flex justify-content-between align-items-center text-inherit text-decoration-none" href="../assets/attachment/course/coursevideo/<?php echo $rows->epv_attachment; ?>">
