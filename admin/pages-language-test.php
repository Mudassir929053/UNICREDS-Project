                            ...
                            <td class="text-center">
                              ...
                              <a class="me-1 text-inherit" href="#">
                                <?php if ($rows->ltq_status == 'Published') : ?>
                                  <a class="btn btn-sm btn-warning shadow" href="admin-function.php?unpublish_ltq=<?php echo $rows->ltq_id; ?>" title="Unpublish Quiz" data-bs-toggle="tooltip" data-placement="top" onclick="return unpublishquiz()">
                                    <!-- <i class="fas fa-toggle-on dropdown-item-icon text-dark" style="vertical-align: middle;"></i> -->
                                    Unpublish</a>
                                <?php endif ?>
                                <?php if ($rows->ltq_status == 'Save Only') : ?>
                                  <a class="btn btn-sm btn-success shadow" href="admin-function.php?publish_ltq=<?php echo $rows->ltq_id; ?>" data-bs-toggle="tooltip" data-placement="top" title="Publish Quiz" onclick="return publishquiz()">
                            ...
                            <td class="text-muted px-4 py-3 align-middle border-top-0">
                              <span class="dropdown dropstart">
                                ...
                                <span class="dropdown-menu" aria-labelledby="ltqDropdown"><span class="dropdown-header">Action</span>
                                  ...
                                  <a class="dropdown-item" href="admin-function.php?delete_ltq=<?php echo $rows->ltq_id; ?>" title="Delete Course" onclick="return deleteltq()"><i class="fe fe-trash dropdown-item-icon text-danger"></i>Delete</a>
                                  <a class="dropdown-item" href="pages-lt-quiz-questions.php?cid=<?php echo $rows->ltq_id; ?>" title="question"><i class="fas fa-question-circle dropdown-item-icon text-danger"></i>Questions</a>
