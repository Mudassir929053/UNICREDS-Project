                     ...
                     <div class="mb-3 mb-md-0">
                        ...
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb">
                              ...
                              <li class="breadcrumb-item">
                                 <a href="#">Skill Test Assessment</a>
                              </li>
                              <li class="breadcrumb-item">
                  ...
                  <div class="tab-content" id="tabContent">
                                    ...
                                    ?>
                                          <tr>
                                             ...
                                             <td class="text-center ">
                                                         ...
                                                         <div class="modal-body">
                                                            <form action="" method="POST" enctype="multipart/form-data" id="editMulti" autocomplete="off">
                                                               ...
                                                               <div class="mb-3 col-12 float-start">
                                                                  ...
                                                                  <textarea class="form-control" name="new_stq_question" id="new_stq_question<?php echo $rows->stq_id; ?>"><?php echo $rows->stq_question; ?></textarea>
                                                                  <script>
                                                                     ClassicEditor
                                                ...
                                                <a class="btn btn-sm btn-danger" href="admin-function.php?delete_skill_assessment_test_quiz=<?php echo $rows->stq_id; ?>&delete_skill_assessment_test_question_answer=<?php echo $rows->stqa_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
                     ...
                     <div class="tab-pane <?php if ($stq_type == "fileupload") {
                        ...
                        <div class="bg-light-info rounded p-2 mb-3 shadow">
                           ...
                           <a class="btn btn-sm btn-danger" href="admin-function.php?delete_language_test_quiz_file=<?php echo $rows->stq_id; ?>" title="Delete Question" onclick="return deletequestion()"><i class="fa fa-trash" aria-hidden="true"></i> Delete</a>
