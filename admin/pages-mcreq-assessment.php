                  ...
                  <div class="border-bottom pb-4 mb-4 d-md-flex align-items-center justify-content-between">
                     ...
                     <div>
                        ...
                        <?php if ($getmcstatus == "Processing") { ?>
                           <a class="btn btn-sm btn-primary waves-effect waves-light shadow" href="pages-mcreq-content.php?mcid=<?php echo $mcid; ?>">
                              View Content </a>
                        <?php } else { ?>
                           <a class="btn btn-sm btn-primary waves-effect waves-light shadow" href="pages-mcreq-content.php?mcid=<?php echo $mcid; ?>">
                                                               ...
                                                               <div class="modal-body">
                                                                  <form action="" method="POST" enctype="multipart/form-data">
                                                                     ...
                                                                     <div class="mb-3">
                                                                        ...
                                                                        <textarea class="form-control" name="new_mcq_instruction" id="instruction<?php echo $rows->mcq_id; ?>"><?php echo $rows->mcq_instruction; ?></textarea>

                                                                        <script>
                                                                           ClassicEditor
                                                                              .create(document.querySelector('#instruction<?php echo $rows->mcq_id; ?>'), {
                                                      ...
                                                      <table class="table table-bordered display no-wrap mb-0" style="width:100%">
                                                         ...
                                                         <tbody class="align-middle">
                                                            ...
                                                            <tr>
                                                               ...
                                                               <td>
                                                                  <?php if ($getmcstatus == "Processing") { ?>
                                                                     <a href="pages-mcreq-assessment-quiz.php?mcid=<?php echo $mcid; ?>&mcq_id=<?php echo $rows->mcq_id ?>" data-bs-toggle="tooltip" data-placement="top" title="Add Question">
                                                   ...
                                                   <table class="table table-bordered text-nowrap mb-0" style="width:100%">
                                                      ...
                                                      <tbody class="align-middle">
                                                         ...
                                                         <tr>
                                                            ...
                                                            <td>
                                                               <?php if ($getmcstatus == "Processing") { ?>
                                                                  <a href="pages-mcreq-assessment-test.php?mcid=<?php echo $mcid; ?>&mct_id=<?php echo $rows->mct_id ?>" data-bs-toggle="tooltip" data-placement="top" title="Add Question">
                                                                     <span class="badge rounded-pill bg-primary">
                                                                        <i class="fe fe-eye fs-4 me-1" style="vertical-align: middle;"></i>
                                                                        View Question
                                                                     </span>
