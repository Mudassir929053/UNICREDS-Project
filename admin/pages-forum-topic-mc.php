                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a class="btn btn-sm btn-outline-danger waves-effect waves-light" href="admin-function.php?delete_forum_topic_mc=<?php echo $ftm_id; ?>&mc_id=<?php echo $mc_id; ?>" title="Delete Topic" onclick="return deleteforumtopic()">
